...
class ContactApi:
    ...
    def contact_schema(
        ...
        _param = self._contact_schema_serialize(
    ...
    @validate_call
    def contact_schema_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def contact_schema_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _contact_schema_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/contacts/schema',
    ...
    def contact_timeline(
        ...
        _param = self._contact_timeline_serialize(
    ...
    @validate_call
    def contact_timeline_with_http_info(
        self,
        contact_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ContactTimelineResponse]:
        """Get the full per-contact timeline (Xentral §4.6/4.7).
    ...
    @validate_call
    def contact_timeline_without_preload_content(
        self,
        contact_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _contact_timeline_serialize(
        self,
        contact_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/contacts/{contact_id}/timeline',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_contact_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/contacts/{contact_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def sales_volume(
        ...
        _param = self._sales_volume_serialize(
            page=page,
            page_size=page_size,
            search=search,
            contact_type=contact_type,
    ...
    @validate_call
    def sales_volume_with_http_info(
        self,
        page: Optional[Annotated[int, Field(strict=True, ge=0)]] = None,
        page_size: Optional[Annotated[int, Field(strict=True, ge=0)]] = None,
        search: Optional[StrictStr] = None,
    ...
    @validate_call
    def sales_volume_without_preload_content(
        self,
        page: Optional[Annotated[int, Field(strict=True, ge=0)]] = None,
        page_size: Optional[Annotated[int, Field(strict=True, ge=0)]] = None,
        search: Optional[StrictStr] = None,
    ...
    def _sales_volume_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/contacts/sales-volume',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
