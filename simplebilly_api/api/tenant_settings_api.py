...
class TenantSettingsApi:
    ...
    def _get_tenant_settings_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/settings/tenant',
    ...
    def update_tenant_settings(
        ...
        :param update_tenant_settings: (required)
        :type update_tenant_settings: UpdateTenantSettings
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _update_tenant_settings_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_tenant_settings is not None:
            _body_params = update_tenant_settings
