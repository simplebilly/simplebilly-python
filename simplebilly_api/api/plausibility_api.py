...
class PlausibilityApi:
    ...
    def plausibility_check_api(
        ...
        _param = self._plausibility_check_api_serialize(
            date_from=date_from,
            date_to=date_to,
    ...
    @validate_call
    def plausibility_check_api_with_http_info(
        self,
        date_from: Optional[StrictStr] = None,
        date_to: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PlausibilityReport]:
        """plausibility_check_api
    ...
    @validate_call
    def plausibility_check_api_without_preload_content(
        self,
        date_from: Optional[StrictStr] = None,
        date_to: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _plausibility_check_api_serialize(
        self,
        date_from,
        date_to,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/bookkeeping/plausibility',
