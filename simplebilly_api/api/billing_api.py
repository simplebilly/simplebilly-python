...
class BillingApi:
    ...
    def get_plans_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiResponseVecPlan]:
        """All canonical plans (free/starter/business/enterprise) — the single source of truth lives in `crate::saasy::plans`, matching marketing.
    ...
    def get_quota_api(
        ...
        _param = self._get_quota_api_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_quota_api_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_quota_api_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_subscription_api(
        ...
        _param = self._get_subscription_api_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiResponseSubscriptionOverview",
            '404': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_subscription_api_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiResponseSubscriptionOverview]:
        """get_subscription_api
    ...
    @validate_call
    def get_subscription_api_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_subscription_api_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def get_usage_api(
        ...
        _param = self._get_usage_api_serialize(
            meter=meter,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_usage_api_with_http_info(
        self,
        meter: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_usage_api_without_preload_content(
        self,
        meter: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def paddle_subscription_webhook(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._paddle_subscription_webhook_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def paddle_subscription_webhook_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def paddle_subscription_webhook_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _paddle_subscription_webhook_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/webhooks/paddle/subscription',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def put_quota_api(
        ...
        _param = self._put_quota_api_serialize(
    ...
    @validate_call
    def put_quota_api_with_http_info(
        self,
        quota_override: QuotaOverride,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def put_quota_api_without_preload_content(
        self,
        quota_override: QuotaOverride,
        _request_timeout: Union[
            None,
