...
class PeppolApi:
    ...
    def peppol_api(
        ...
        _param = self._peppol_api_serialize(
            id=id,
    ...
    @validate_call
    def peppol_api_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _peppol_api_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/invoices/{id}/peppol',
