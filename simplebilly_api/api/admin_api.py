...
class AdminApi:
    ...
    def trigger_mirror(
        ...
        _param = self._trigger_mirror_serialize(
    ...
    @validate_call
    def trigger_mirror_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MirrorTriggerResponse]:
        """trigger_mirror
    ...
    @validate_call
    def trigger_mirror_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _trigger_mirror_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/admin/storage/mirror',
