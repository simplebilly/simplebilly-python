...
class KstApi:
    ...
    def kst_api(
        self,
        year: StrictInt,
        gewinn: Optional[StrictStr] = None,
        ...
        _param = self._kst_api_serialize(
            year=year,
            gewinn=gewinn,
    ...
    @validate_call
    def kst_api_without_preload_content(
        self,
        year: StrictInt,
        gewinn: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _kst_api_serialize(
        ...
        if gewinn is not None:
            ...
            _query_params.append(('gewinn', gewinn))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/bookkeeping/kst',
