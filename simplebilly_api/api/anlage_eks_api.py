...
class AnlageEksApi:
    ...
    def eks_api(
        ...
        _param = self._eks_api_serialize(
            year=year,
    ...
    @validate_call
    def eks_api_without_preload_content(
        self,
        year: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _eks_api_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/bookkeeping/eks',
