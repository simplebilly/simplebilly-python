...
class CreditNoteApi:
    ...
    def download_credit_note_pdf(
        ...
        _param = self._download_credit_note_pdf_serialize(
    ...
    @validate_call
    def download_credit_note_pdf_with_http_info(
        self,
        credit_note_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def download_credit_note_pdf_without_preload_content(
        self,
        credit_note_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _download_credit_note_pdf_serialize(
        self,
        credit_note_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/credit-notes/{credit_note_id}/pdf',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
