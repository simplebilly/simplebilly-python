...
class OffenlegungApi:
    ...
    def offenlegung_api(
        ...
        _param = self._offenlegung_api_serialize(
    ...
    @validate_call
    def offenlegung_api_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def offenlegung_api_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _offenlegung_api_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/bookkeeping/offenlegung',
