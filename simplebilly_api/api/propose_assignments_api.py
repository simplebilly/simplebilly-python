...
class ProposeAssignmentsApi:
    ...
    def propose_assignments_api(
        ...
        _param = self._propose_assignments_api_serialize(
    ...
    @validate_call
    def propose_assignments_api_with_http_info(
        self,
        min_confidence: Optional[Union[StrictFloat, StrictInt]] = None,
        customer_id: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ProposedAssignment]]:
        """propose_assignments_api
    ...
    @validate_call
    def propose_assignments_api_without_preload_content(
        self,
        min_confidence: Optional[Union[StrictFloat, StrictInt]] = None,
        customer_id: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _propose_assignments_api_serialize(
        self,
        min_confidence,
        customer_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/bookkeeping/propose-assignments',
