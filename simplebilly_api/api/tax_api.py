...
class TaxApi:
    ...
    def create_tax_rate(
        ...
        :param tax_rate_create: (required)
        :type tax_rate_create: TaxRateCreate
    ...
    def _create_tax_rate_serialize(
        ...
        if tax_rate_create is not None:
            _body_params = tax_rate_create
    ...
    def _delete_tax_rate_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/tax-rates/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
