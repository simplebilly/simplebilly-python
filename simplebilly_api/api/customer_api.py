...
class CustomerApi:
    ...
    def customer_restore(
        ...
        _param = self._customer_restore_serialize(
    ...
    @validate_call
    def customer_restore_with_http_info(
        self,
        customer_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def customer_restore_without_preload_content(
        self,
        customer_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _customer_restore_serialize(
        self,
        customer_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/customers/{customer_id}/restore',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
