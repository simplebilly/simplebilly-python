...
class PaymentConditionApi:
    ...
    @validate_call
    def list_payment_conditions_api(
        self,
        ...
        _param = self._list_payment_conditions_api_serialize(
    ...
    @validate_call
    def list_payment_conditions_api_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[PaymentCondition]]:
        """list_payment_conditions_api
    ...
    @validate_call
    def list_payment_conditions_api_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_payment_conditions_api_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/payment-conditions',
