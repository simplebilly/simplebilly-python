...
class AnlageSApi:
    ...
    def anlage_s_api(
        ...
        _param = self._anlage_s_api_serialize(
            year=year,
    ...
    @validate_call
    def anlage_s_api_with_http_info(
        self,
        year: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def anlage_s_api_without_preload_content(
        self,
        year: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _anlage_s_api_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/bookkeeping/anlage-s',
