...
class DatevImportApi:
    ...
    def datev_import_api(
        ...
        _param = self._datev_import_api_serialize(
            body=body,
    ...
    @validate_call
    def datev_import_api_with_http_info(
        self,
        body: Optional[Any],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DatevImportResponse]:
        """datev_import_api
    ...
    @validate_call
    def datev_import_api_without_preload_content(
        self,
        body: Optional[Any],
        _request_timeout: Union[
            None,
    ...
    def _datev_import_api_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/bookkeeping/datev/import',
