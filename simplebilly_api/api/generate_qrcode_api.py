...
class GenerateQrcodeApi:
    ...
    def generate_qrcode_api(
        ...
        iban: StrictStr,
        id: StrictStr,
        holder_name: Optional[StrictStr] = None,
        ...
        _param = self._generate_qrcode_api_serialize(
            iban=iban,
            id=id,
    ...
    @validate_call
    def generate_qrcode_api_with_http_info(
        self,
        iban: StrictStr,
        id: StrictStr,
        holder_name: Optional[StrictStr] = None,
    ...
    @validate_call
    def generate_qrcode_api_without_preload_content(
        self,
        iban: StrictStr,
        id: StrictStr,
        holder_name: Optional[StrictStr] = None,
    ...
    def _generate_qrcode_api_serialize(
        self,
        iban,
        id,
        holder_name,
        ...
        if holder_name is not None:
            ...
            _query_params.append(('holder_name', holder_name))
            
        if bic is not None:
            
            _query_params.append(('bic', bic))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/invoices/{id}/qrcode',
