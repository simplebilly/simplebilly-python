...
class OssReportApi:
    ...
    def oss_report_api(
        ...
        _param = self._oss_report_api_serialize(
    ...
    @validate_call
    def oss_report_api_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def oss_report_api_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _oss_report_api_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/bookkeeping/oss',
