...
class KostenVorschauApi:
    ...
    def kosten_vorschau_api(
        ...
        _param = self._kosten_vorschau_api_serialize(
            year=year,
            month=month,
    ...
    @validate_call
    def kosten_vorschau_api_with_http_info(
        self,
        year: StrictInt,
        month: Annotated[int, Field(strict=True, ge=0)],
        _request_timeout: Union[
    ...
    @validate_call
    def kosten_vorschau_api_without_preload_content(
        self,
        year: StrictInt,
        month: Annotated[int, Field(strict=True, ge=0)],
        _request_timeout: Union[
    ...
    def _kosten_vorschau_api_serialize(
        self,
        year,
        month,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/bookkeeping/kosten-vorschau',
