...
class DatevApi:
    ...
    @validate_call
    def datev_export_api(
        self,
        account_schema: Optional[StrictStr] = None,
        ...
        :param account_schema:
        :type account_schema: str
        :param date_from:
        :type date_from: str
        :param date_to:
        :type date_to: str
        ...
        _param = self._datev_export_api_serialize(
    ...
    @validate_call
    def datev_export_api_with_http_info(
        self,
        account_schema: Optional[StrictStr] = None,
        date_from: Optional[StrictStr] = None,
        date_to: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DatevExportResponse]:
        """Export bookkeeping data as DATEV CSV
    ...
    @validate_call
    def datev_export_api_without_preload_content(
        self,
        account_schema: Optional[StrictStr] = None,
        date_from: Optional[StrictStr] = None,
        date_to: Optional[StrictStr] = None,
    ...
    def _datev_export_api_serialize(
        self,
        account_schema,
        date_from,
        date_to,
        ...
        if account_schema is not None:
            ...
            _query_params.append(('account_schema', account_schema))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/bookkeeping/datev/export',
    ...
    def datev_preview_api(
        ...
        _param = self._datev_preview_api_serialize(
            account_schema=account_schema,
            date_from=date_from,
            date_to=date_to,
            page=page,
    ...
    @validate_call
    def datev_preview_api_with_http_info(
        self,
        account_schema: Optional[StrictStr] = None,
        date_from: Optional[StrictStr] = None,
        date_to: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[DatevBookingPreview]]:
        """Exported_datev_bookings: returns formed bookings for review
    ...
    @validate_call
    def datev_preview_api_without_preload_content(
        self,
        account_schema: Optional[StrictStr] = None,
        date_from: Optional[StrictStr] = None,
        date_to: Optional[StrictStr] = None,
    ...
    def _datev_preview_api_serialize(
        self,
        account_schema,
        date_from,
        date_to,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/bookkeeping/datev/preview',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
