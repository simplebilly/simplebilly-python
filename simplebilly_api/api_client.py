...
from simplebilly_api.configuration import Configuration
from simplebilly_api.api_response import ApiResponse, T as ApiResponseT
import simplebilly_api.models
from simplebilly_api import rest
from simplebilly_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(simplebilly_api.models, klass)
