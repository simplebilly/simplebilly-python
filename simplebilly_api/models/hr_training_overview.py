...
class HrTrainingOverview(BaseModel):
    """
    HrTrainingOverview
    """ # noqa: E501
    assigned_count: StrictInt = Field(alias="assignedCount")
    code: StrictStr
    completed_count: StrictInt = Field(alias="completedCount")
    overdue_count: StrictInt = Field(alias="overdueCount")
    title: StrictStr
    training_id: UUID = Field(alias="trainingId")
    __properties: ClassVar[List[str]] = ["assignedCount", "code", "completedCount", "overdueCount", "title", "trainingId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "overdueCount": obj.get("overdueCount"),
            "title": obj.get("title"),
