...
class ConfigFieldKindOneOf1(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['secret']):
            raise ValueError("must be one of enum values ('secret')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigFieldKindOneOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigFieldKindOneOf1 from a dict"""
        if obj is None:
            return None
