...
class SubmitResultResponse(BaseModel):
    ...
    completion_id: UUID = Field(alias="completionId")
    pass_score: StrictInt = Field(alias="passScore")
    passed: StrictBool
    score: StrictInt
    valid_until: Optional[datetime] = Field(default=None, alias="validUntil")
    __properties: ClassVar[List[str]] = ["certificateId", "completionId", "passScore", "passed", "score", "validUntil"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "completionId": obj.get("completionId"),
