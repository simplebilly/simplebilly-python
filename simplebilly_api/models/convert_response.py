...
class ConvertResponse(BaseModel):
    ...
    proforma_id: StrictStr = Field(alias="proformaId")
    proforma_number: StrictStr = Field(alias="proformaNumber")
    __properties: ClassVar[List[str]] = ["invoiceId", "invoiceNumber", "proformaId", "proformaNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "proformaId": obj.get("proformaId"),
            "proformaNumber": obj.get("proformaNumber")
        })
        return _obj
