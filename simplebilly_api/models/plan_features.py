...
class PlanFeatures(BaseModel):
    ...
    """ # noqa: E501
    connectors: StrictBool
    erp: StrictBool
    fancy_reports: StrictBool = Field(alias="fancyReports")
    tax_automations: StrictBool = Field(alias="taxAutomations")
    __properties: ClassVar[List[str]] = ["connectors", "erp", "fancyReports", "taxAutomations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "erp": obj.get("erp"),
            "fancyReports": obj.get("fancyReports"),
            "taxAutomations": obj.get("taxAutomations")
        })
        return _obj
