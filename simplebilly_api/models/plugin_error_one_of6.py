...
class PluginErrorOneOf6(BaseModel):
    """
    PluginErrorOneOf6
    """ # noqa: E501
    not_implemented: StrictStr = Field(alias="NotImplemented")
    __properties: ClassVar[List[str]] = ["NotImplemented"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PluginErrorOneOf6 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PluginErrorOneOf6 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "NotImplemented": obj.get("NotImplemented")
        })
        return _obj
