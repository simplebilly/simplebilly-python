...
class GoodsReceipt(BaseModel):
    ...
    GoodsReceipt
    """ # noqa: E501
    gr_number: StrictStr = Field(alias="grNumber")
    line_items: Optional[Any] = Field(description="JSON array of `{product_id, name, quantity, batch_number?, expiry_date?, bin_location?}`.", alias="lineItems")
    ...
    __properties: ClassVar[List[str]] = ["grNumber", "lineItems", "notes", "purchaseOrderId", "receiptDate", "supplierContactId", "supplierName", "warehouseId"]
