...
class ContactInfo(BaseModel):
    ...
    """ # noqa: E501
    hint: StrictStr
    hint_en: StrictStr = Field(alias="hintEn")
    role: StrictStr
    role_en: StrictStr = Field(alias="roleEn")
    __properties: ClassVar[List[str]] = ["hint", "hintEn", "role", "roleEn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hint": obj.get("hint"),
            "hintEn": obj.get("hintEn"),
            "role": obj.get("role"),
            "roleEn": obj.get("roleEn")
        })
        return _obj
