...
class StilleReport(BaseModel):
    ...
    year: StrictInt
    __properties: ClassVar[List[str]] = ["jahresueberschuss", "partners", "year"]
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.partners:
            for _item_partners in self.partners:
                _items.append(_item_partners.to_dict() if _item_partners is not None else None)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "partners": [StillePartnerZeile.from_dict(_item) for _item in obj["partners"]] if obj.get("partners") is not None else None,
            "year": obj.get("year")
        })
        return _obj
