...
class SmtpConfig(BaseModel):
    ...
    timeout_seconds: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    username: StrictStr
    __properties: ClassVar[List[str]] = ["encryption", "from_address", "from_name", "host", "password", "port", "timeout_seconds", "username"]
