...
class KonzernBeteiligung(BaseModel):
    """
    KonzernBeteiligung
    """ # noqa: E501
    company_name: StrictStr
    control_basis: List[StrictStr] = Field(description="Erfüllte Kontroll-Indikatoren (§ 290 Abs. 2 HGB) als deutsche Bezeichnungen.")
    controlled: StrictBool
    ownership_pct: StrictStr
    __properties: ClassVar[List[str]] = ["company_name", "control_basis", "controlled", "ownership_pct"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "control_basis": obj.get("control_basis"),
            "controlled": obj.get("controlled"),
            "ownership_pct": obj.get("ownership_pct")
        })
        return _obj
