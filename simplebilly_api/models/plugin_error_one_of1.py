...
class PluginErrorOneOf1(BaseModel):
    """
    PluginErrorOneOf1
    """ # noqa: E501
    not_found: Annotated[List[Dict[str, Any]], Field(min_length=2, max_length=2)] = Field(alias="NotFound")
    __properties: ClassVar[List[str]] = ["NotFound"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PluginErrorOneOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PluginErrorOneOf1 from a dict"""
        if obj is None:
            return None
