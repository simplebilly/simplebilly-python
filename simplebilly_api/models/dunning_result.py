...
class DunningResult(BaseModel):
    ...
    DunningResult
    """ # noqa: E501
    invoices_processed: Annotated[int, Field(strict=True, ge=0)]
    message: StrictStr
    __properties: ClassVar[List[str]] = ["invoices_processed", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoices_processed": obj.get("invoices_processed"),
