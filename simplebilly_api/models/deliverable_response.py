...
class DeliverableResponse(BaseModel):
    ...
    DeliverableResponse
    """ # noqa: E501
    available_stock: StrictInt = Field(alias="availableStock")
    deliverable_quantity: StrictInt = Field(alias="deliverableQuantity")
    max_sellable: Optional[StrictInt] = Field(default=None, alias="maxSellable")
    product_id: UUID = Field(alias="productId")
    reserved_stock: StrictInt = Field(alias="reservedStock")
    warehouse_id: Optional[StrictStr] = Field(default=None, alias="warehouseId")
    __properties: ClassVar[List[str]] = ["availableStock", "deliverableQuantity", "maxSellable", "productId", "reservedStock", "warehouseId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deliverableQuantity": obj.get("deliverableQuantity"),
            "maxSellable": obj.get("maxSellable"),
            "productId": obj.get("productId"),
            "reservedStock": obj.get("reservedStock"),
