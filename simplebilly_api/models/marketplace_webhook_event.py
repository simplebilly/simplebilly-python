...
class MarketplaceWebhookEvent(BaseModel):
    ...
    event_body: Optional[Any] = Field(default=None, alias="eventBody")
    ...
    __properties: ClassVar[List[str]] = ["connectionId", "eventBody", "eventType", "headers", "platform", "processed", "processingError"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if event_body (nullable) is None
        # and model_fields_set contains the field
        if self.event_body is None and "event_body" in self.model_fields_set:
            _dict['eventBody'] = None
