...
class AbsenceUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["absenceType", "approvedAt", "approvedBy", "employeeId", "endDate", "notes", "startDate", "status"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if absence_type (nullable) is None
        # and model_fields_set contains the field
        if self.absence_type is None and "absence_type" in self.model_fields_set:
            _dict['absenceType'] = None
