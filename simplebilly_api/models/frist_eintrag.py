...
class FristEintrag(BaseModel):
    """
    FristEintrag
    """ # noqa: E501
    bezeichnung: StrictStr
    faellig: StrictStr
    faellig_original: StrictStr
    hinweis: Optional[StrictStr] = None
    typ: StrictStr
    zeitraum: StrictStr
    __properties: ClassVar[List[str]] = ["bezeichnung", "faellig", "faellig_original", "hinweis", "typ", "zeitraum"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "faellig": obj.get("faellig"),
            "faellig_original": obj.get("faellig_original"),
