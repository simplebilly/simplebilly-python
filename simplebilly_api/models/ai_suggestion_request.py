...
class AiSuggestionRequest(BaseModel):
    ...
    message_body: Optional[StrictStr] = None
    ticket_id: UUID
    __properties: ClassVar[List[str]] = ["instructions", "message_body", "ticket_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if message_body (nullable) is None
        # and model_fields_set contains the field
        if self.message_body is None and "message_body" in self.model_fields_set:
            _dict['message_body'] = None
