...
class KostenVorschau(BaseModel):
    """
    KostenVorschau
    """ # noqa: E501
    eintraege: List[KostenEintrag]
    gesamt: StrictStr
    __properties: ClassVar[List[str]] = ["eintraege", "gesamt"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in eintraege (list)
        _items = []
        if self.eintraege:
            for _item_eintraege in self.eintraege:
                _items.append(_item_eintraege.to_dict() if _item_eintraege is not None else None)
            _dict['eintraege'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "eintraege": [KostenEintrag.from_dict(_item) for _item in obj["eintraege"]] if obj.get("eintraege") is not None else None,
