...
class PluginErrorOneOf4(BaseModel):
    """
    PluginErrorOneOf4
    """ # noqa: E501
    database_error: Annotated[List[Dict[str, Any]], Field(min_length=2, max_length=2)] = Field(alias="DatabaseError")
    __properties: ClassVar[List[str]] = ["DatabaseError"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PluginErrorOneOf4 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PluginErrorOneOf4 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "DatabaseError": obj.get("DatabaseError")
        })
        return _obj
