...
class TimelineEvent(BaseModel):
    ...
    """ # noqa: E501
    var_date: StrictStr = Field(description="RFC3339 UTC timestamp for sorting.", alias="date")
    detail: Optional[StrictStr] = None
    id: StrictStr = Field(description="Source record id (stringified).")
    status: Optional[StrictStr] = None
    title: StrictStr
    type: StrictStr = Field(description="Source module: communication | quotation | order | invoice | attachment.")
    __properties: ClassVar[List[str]] = ["date", "detail", "id", "status", "title", "type"]
