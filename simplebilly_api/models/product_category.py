...
class ProductCategory(BaseModel):
    ...
    name: StrictStr
    parent_category_id: Optional[StrictStr] = Field(default=None, description="References the category entity.", alias="parentCategoryId")
    sort_order: StrictInt = Field(alias="sortOrder")
    __properties: ClassVar[List[str]] = ["description", "name", "parentCategoryId", "sortOrder"]
