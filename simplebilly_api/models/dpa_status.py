...
class DpaStatus(BaseModel):
    """
    DPA acceptance status of the tenant.
    """ # noqa: E501
    accepted: StrictBool
    accepted_at: Optional[StrictStr] = Field(default=None, alias="acceptedAt")
    accepted_by: Optional[StrictStr] = Field(default=None, alias="acceptedBy")
    version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["accepted", "acceptedAt", "acceptedBy", "version"]
