...
class PublicDeliveryAppointmentStatusResponse(BaseModel):
    """
    PublicDeliveryAppointmentStatusResponse
    """ # noqa: E501
    appointment_id: StrictStr = Field(alias="appointmentId")
    requested_date: date = Field(alias="requestedDate")
    status: StrictStr
    time_slot: Optional[StrictStr] = Field(default=None, alias="timeSlot")
    warehouse_name: StrictStr = Field(alias="warehouseName")
    __properties: ClassVar[List[str]] = ["appointmentId", "requestedDate", "status", "timeSlot", "warehouseName"]
