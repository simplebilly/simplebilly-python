...
class ContactHistoryResponse(BaseModel):
    ...
    inbound_count: Annotated[int, Field(strict=True, ge=0)] = Field(alias="inboundCount")
    items: List[CustomerCommunication]
    outbound_count: Annotated[int, Field(strict=True, ge=0)] = Field(alias="outboundCount")
    __properties: ClassVar[List[str]] = ["contactId", "inboundCount", "items", "outboundCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inboundCount": obj.get("inboundCount"),
            "items": [CustomerCommunication.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "outboundCount": obj.get("outboundCount")
        })
        return _obj
