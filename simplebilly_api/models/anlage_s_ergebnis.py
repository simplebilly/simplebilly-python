...
class AnlageSErgebnis(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["gewinn_verlust", "jahr", "kfz_hinweise"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jahr": obj.get("jahr"),
            "kfz_hinweise": [AnlageSKfzHinweis.from_dict(_item) for _item in obj["kfz_hinweise"]] if obj.get("kfz_hinweise") is not None else None
        })
        return _obj
