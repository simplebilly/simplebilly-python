...
class RegisterRequest(BaseModel):
    ...
    last_name: StrictStr
    password: StrictStr
    privacy_accepted: StrictBool = Field(description="GDPR consent — registration is rejected unless true.")
    __properties: ClassVar[List[str]] = ["company_name", "email", "first_name", "last_name", "password", "privacy_accepted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "privacy_accepted": obj.get("privacy_accepted")
        })
        return _obj
