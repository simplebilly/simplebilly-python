...
class ProviderInfo(BaseModel):
    ...
    name: StrictStr
    requires_api_key: StrictBool
    services: List[StrictStr]
    supports_label_creation: StrictBool
    supports_rate_estimation: StrictBool
    supports_tracking: StrictBool
    __properties: ClassVar[List[str]] = ["display_name", "name", "requires_api_key", "services", "supports_label_creation", "supports_rate_estimation", "supports_tracking"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supports_label_creation": obj.get("supports_label_creation"),
            "supports_rate_estimation": obj.get("supports_rate_estimation"),
