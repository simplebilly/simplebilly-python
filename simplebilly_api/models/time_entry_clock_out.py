...
class TimeEntryClockOut(BaseModel):
    ...
    """ # noqa: E501
    clock_out: datetime
    hours: Optional[StrictStr] = Field(default=None, description="Optional manual hours; when absent, derived from clock_in..clock_out.")
    __properties: ClassVar[List[str]] = ["clock_out", "hours"]
