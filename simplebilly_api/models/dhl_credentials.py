...
class DhlCredentials(BaseModel):
    ...
    DhlCredentials
    """ # noqa: E501
    api_key: StrictStr = Field(description="DHL-API-Key from developer.dhl.com (required for tracking).")
    client_id: Optional[StrictStr] = Field(default=None, description="Client credentials from the DHL developer app; required for label creation.")
    client_secret: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["api_key", "client_id", "client_secret"]
