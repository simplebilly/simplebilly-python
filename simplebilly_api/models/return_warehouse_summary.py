...
class ReturnWarehouseSummary(BaseModel):
    """
    Aggregation for a single warehouse.
    """ # noqa: E501
    items_restocked: StrictInt = Field(alias="itemsRestocked")
    items_scrapped: StrictInt = Field(alias="itemsScrapped")
    returns: Annotated[int, Field(strict=True, ge=0)]
    warehouse_id: Optional[StrictStr] = Field(default=None, alias="warehouseId")
    __properties: ClassVar[List[str]] = ["itemsRestocked", "itemsScrapped", "returns", "warehouseId"]
