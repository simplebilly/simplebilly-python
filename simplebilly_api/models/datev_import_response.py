...
class DatevImportResponse(BaseModel):
    """
    DatevImportResponse
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["count", "filename", "rows"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rows": [DatevImportRow.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj
