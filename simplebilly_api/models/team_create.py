...
class TeamCreate(BaseModel):
    ...
    name: StrictStr
    parent_team_id: Optional[UUID] = Field(default=None, alias="parentTeamId")
    __properties: ClassVar[List[str]] = ["description", "name", "parentTeamId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "parentTeamId": obj.get("parentTeamId")
        })
        return _obj
