...
class ReorderProposalResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["generatedAt", "lines", "totalSuggestedQuantity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lines": [ReorderProposalLine.from_dict(_item) for _item in obj["lines"]] if obj.get("lines") is not None else None,
