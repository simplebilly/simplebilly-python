...
class OffenlegungItem(BaseModel):
    """
    OffenlegungItem
    """ # noqa: E501
    exists: StrictBool = Field(description="Ob die zugrunde liegenden Daten im System vorhanden sind.")
    name: StrictStr = Field(description="Bezeichnung des Offenlegungsbestandteils (§ 325 Abs. 1 HGB).")
    source: StrictStr = Field(description="Woher der Bestandteil stammt bzw. fehlt.")
    __properties: ClassVar[List[str]] = ["exists", "name", "source"]
