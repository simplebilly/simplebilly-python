...
class QuartileBand(BaseModel):
    """
    QuartileBand
    """ # noqa: E501
    female_share_pct: Union[StrictFloat, StrictInt]
    hourly_median: StrictStr
    male_share_pct: Union[StrictFloat, StrictInt]
    quartile: StrictStr
    __properties: ClassVar[List[str]] = ["female_share_pct", "hourly_median", "male_share_pct", "quartile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "female_share_pct": obj.get("female_share_pct"),
            "hourly_median": obj.get("hourly_median"),
            "male_share_pct": obj.get("male_share_pct"),
            "quartile": obj.get("quartile")
        })
        return _obj
