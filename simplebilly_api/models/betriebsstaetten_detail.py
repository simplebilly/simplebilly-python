...
class BetriebsstaettenDetail(BaseModel):
    """
    BetriebsstaettenDetail
    """ # noqa: E501
    beschaefigte: Annotated[int, Field(strict=True, ge=0)]
    monatlicher_beitrag: StrictStr
    name: StrictStr
    __properties: ClassVar[List[str]] = ["beschaefigte", "monatlicher_beitrag", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "beschaefigte": obj.get("beschaefigte"),
