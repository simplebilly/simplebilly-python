...
class SepaDirectDebitResponse(BaseModel):
    """
    SepaDirectDebitResponse
    """ # noqa: E501
    content_type: StrictStr
    filename: StrictStr
    xml_content: StrictStr
    __properties: ClassVar[List[str]] = ["content_type", "filename", "xml_content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "xml_content": obj.get("xml_content")
        })
        return _obj
