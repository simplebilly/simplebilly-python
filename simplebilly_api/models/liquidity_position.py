...
class LiquidityPosition(BaseModel):
    ...
    LiquidityPosition
    """ # noqa: E501
    accounts_payable: Union[StrictFloat, StrictInt]
    accounts_receivable: Union[StrictFloat, StrictInt]
    cash_and_equivalents: Union[StrictFloat, StrictInt]
    current_ratio: Union[StrictFloat, StrictInt]
    quick_ratio: Union[StrictFloat, StrictInt]
    working_capital: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["accounts_payable", "accounts_receivable", "cash_and_equivalents", "current_ratio", "quick_ratio", "working_capital"]
