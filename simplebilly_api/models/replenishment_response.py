...
class ReplenishmentResponse(BaseModel):
    ...
    total_suggested_quantity: StrictInt = Field(alias="totalSuggestedQuantity")
    __properties: ClassVar[List[str]] = ["generatedAt", "lines", "targetWarehouseId", "totalSuggestedQuantity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lines": [ReplenishmentSuggestionLine.from_dict(_item) for _item in obj["lines"]] if obj.get("lines") is not None else None,
            "targetWarehouseId": obj.get("targetWarehouseId"),
            "totalSuggestedQuantity": obj.get("totalSuggestedQuantity")
        })
        return _obj
