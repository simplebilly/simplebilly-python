...
class CustomerInfo(BaseModel):
    ...
    """ # noqa: E501
    annual_volume: Annotated[int, Field(strict=True, ge=0)]
    is_registered: StrictBool
    __properties: ClassVar[List[str]] = ["annual_volume", "is_registered"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "annual_volume": obj.get("annual_volume"),
