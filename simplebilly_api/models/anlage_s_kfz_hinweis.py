...
class AnlageSKfzHinweis(BaseModel):
    ...
    kennzeichen: StrictStr
    privat_anteil_prozent: StrictStr
    __properties: ClassVar[List[str]] = ["bezeichnung", "kennzeichen", "privat_anteil_prozent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kennzeichen": obj.get("kennzeichen"),
            "privat_anteil_prozent": obj.get("privat_anteil_prozent")
        })
        return _obj
