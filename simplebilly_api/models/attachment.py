...
class Attachment(BaseModel):
    ...
    ocr_text: Optional[StrictStr] = Field(default=None, description="Raw text extracted by client-side OCR (tesseract.js), if run.", alias="ocrText")
    ...
    __properties: ClassVar[List[str]] = ["contactId", "fileName", "fileSize", "mimeType", "ocrText", "originalName", "pdfaPath", "sha256Hash", "uploadedBy"]
