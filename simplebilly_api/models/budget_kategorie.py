...
class BudgetKategorie(BaseModel):
    """
    BudgetKategorie
    """ # noqa: E501
    budget: StrictStr
    differenz: StrictStr
    goal: Optional[StrictStr] = Field(default=None, description="User-set monthly goal for the category, if any.")
    ist: StrictStr
    kategorie: StrictStr
    __properties: ClassVar[List[str]] = ["budget", "differenz", "goal", "ist", "kategorie"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "differenz": obj.get("differenz"),
            "goal": obj.get("goal"),
            "ist": obj.get("ist"),
            "kategorie": obj.get("kategorie")
        })
        return _obj
