...
class QuizQuestion(BaseModel):
    ...
    options_en: List[StrictStr] = Field(alias="optionsEn")
    question: StrictStr
    question_en: StrictStr = Field(alias="questionEn")
    __properties: ClassVar[List[str]] = ["id", "options", "optionsEn", "question", "questionEn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "optionsEn": obj.get("optionsEn"),
            "question": obj.get("question"),
            "questionEn": obj.get("questionEn")
        })
        return _obj
