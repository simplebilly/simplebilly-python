...
class SalesVolumeReport(BaseModel):
    """
    SalesVolumeReport
    """ # noqa: E501
    grand_total: StrictStr
    items: List[SalesVolumeItem]
    total_count: StrictInt
    __properties: ClassVar[List[str]] = ["grand_total", "items", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [SalesVolumeItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
