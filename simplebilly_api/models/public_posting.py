...
class PublicPosting(BaseModel):
    ...
    employment_type: Optional[StrictStr] = Field(default=None, alias="employmentType")
    id: UUID
    location: Optional[StrictStr] = None
    remote: StrictBool
    required_skills: List[StrictStr] = Field(alias="requiredSkills")
    ...
    title: StrictStr
    __properties: ClassVar[List[str]] = ["currency", "description", "employmentType", "id", "location", "remote", "requiredSkills", "requirements", "salaryMax", "salaryMin", "title"]
