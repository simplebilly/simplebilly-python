...
class EmissionFactorResponse(BaseModel):
    ...
    kg_co2e_per_unit: Union[StrictFloat, StrictInt]
    name_de: StrictStr
    source: StrictStr
    unit: StrictStr
    version: StrictStr
    __properties: ClassVar[List[str]] = ["category_id", "kg_co2e_per_unit", "name_de", "source", "unit", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kg_co2e_per_unit": obj.get("kg_co2e_per_unit"),
