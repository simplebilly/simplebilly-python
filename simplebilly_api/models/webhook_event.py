...
class WebhookEvent(BaseModel):
    ...
    channel: Optional[StrictStr] = Field(default=None, description="source for inbound, target URL for outbound.")
    direction: WebhookDirection = Field(description="inbound | outbound")
    event_type: StrictStr = Field(alias="eventType")
    last_error: Optional[StrictStr] = Field(default=None, alias="lastError")
    payload: Optional[Any] = None
    status: Optional[WebhookEventStatus] = Field(default=None, description="accepted | delivered | failed")
    __properties: ClassVar[List[str]] = ["attempts", "channel", "direction", "eventType", "lastError", "payload", "status"]
