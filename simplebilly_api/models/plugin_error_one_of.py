...
class PluginErrorOneOf(BaseModel):
    """
    PluginErrorOneOf
    """ # noqa: E501
    bad_request: Annotated[List[Dict[str, Any]], Field(min_length=2, max_length=2)] = Field(alias="BadRequest")
    __properties: ClassVar[List[str]] = ["BadRequest"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PluginErrorOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PluginErrorOneOf from a dict"""
        if obj is None:
            return None
