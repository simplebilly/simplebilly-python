...
class DataQuality(BaseModel):
    ...
    DataQuality
    """ # noqa: E501
    activity_lines: Annotated[int, Field(strict=True, ge=0)]
    activity_share_pct: Union[StrictFloat, StrictInt]
    spend_lines: Annotated[int, Field(strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["activity_lines", "activity_share_pct", "spend_lines"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity_lines": obj.get("activity_lines"),
            "activity_share_pct": obj.get("activity_share_pct"),
            "spend_lines": obj.get("spend_lines")
        })
        return _obj
