...
class TrainingAssignmentUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["assignedBy", "dueDate", "employeeId", "notes", "status", "trainingId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if training_id (nullable) is None
        # and model_fields_set contains the field
        if self.training_id is None and "training_id" in self.model_fields_set:
            _dict['trainingId'] = None
