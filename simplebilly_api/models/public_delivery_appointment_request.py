...
class PublicDeliveryAppointmentRequest(BaseModel):
    """
    ...
    time_slot: Optional[StrictStr] = Field(default=None, alias="timeSlot")
    warehouse_code: StrictStr = Field(description="Warehouse `code` — the supplier does not know the warehouse uuid.", alias="warehouseCode")
    __properties: ClassVar[List[str]] = ["email", "notes", "requestedDate", "supplierName", "timeSlot", "warehouseCode"]
