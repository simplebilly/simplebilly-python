...
class ConfigFieldKindOneOf3(BaseModel):
    """
    ConfigFieldKindOneOf3
    """ # noqa: E501
    options: List[StrictStr]
    type: StrictStr
    __properties: ClassVar[List[str]] = ["options", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['select']):
            raise ValueError("must be one of enum values ('select')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigFieldKindOneOf3 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigFieldKindOneOf3 from a dict"""
        if obj is None:
            return None
