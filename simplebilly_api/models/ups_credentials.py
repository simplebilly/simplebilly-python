...
class UpsCredentials(BaseModel):
    ...
    UpsCredentials
    """ # noqa: E501
    client_id: StrictStr = Field(description="OAuth 2.0 client credentials from developer.ups.com.")
    client_secret: StrictStr
    shipper_number: Optional[StrictStr] = Field(default=None, description="UPS account number; required for label creation, optional for rates/tracking.")
    __properties: ClassVar[List[str]] = ["client_id", "client_secret", "shipper_number"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if shipper_number (nullable) is None
        # and model_fields_set contains the field
        if self.shipper_number is None and "shipper_number" in self.model_fields_set:
            _dict['shipper_number'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shipper_number": obj.get("shipper_number")
        })
        return _obj
