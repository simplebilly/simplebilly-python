...
class CustomerCommunicationUpdate(BaseModel):
    ...
    contact_id: Optional[StrictStr] = Field(default=None, description="The contact (customer/supplier) this communication belongs to. References the contact entity.", alias="contactId")
