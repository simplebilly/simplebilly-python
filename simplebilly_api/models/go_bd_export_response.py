...
class GoBDExportResponse(BaseModel):
    """
    GoBDExportResponse
    """ # noqa: E501
    booking_count: Annotated[int, Field(strict=True, ge=0)]
    csv_content: StrictStr
    filename: StrictStr
    __properties: ClassVar[List[str]] = ["booking_count", "csv_content", "filename"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "booking_count": obj.get("booking_count"),
