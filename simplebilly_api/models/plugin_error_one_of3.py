...
class PluginErrorOneOf3(BaseModel):
    """
    PluginErrorOneOf3
    """ # noqa: E501
    internal_error: Annotated[List[Dict[str, Any]], Field(min_length=2, max_length=2)] = Field(alias="InternalError")
    __properties: ClassVar[List[str]] = ["InternalError"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PluginErrorOneOf3 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PluginErrorOneOf3 from a dict"""
        if obj is None:
            return None
