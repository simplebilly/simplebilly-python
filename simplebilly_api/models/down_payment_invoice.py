...
class DownPaymentInvoice(BaseModel):
    ...
    paid_amount: StrictStr
    total_amount: StrictStr
    voucher_date: date
    voucher_number: Optional[StrictStr] = None
    voucher_status: StrictStr
    __properties: ClassVar[List[str]] = ["contact_id", "contact_name", "created_at", "currency", "id", "notes", "paid_amount", "total_amount", "voucher_date", "voucher_number", "voucher_status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "voucher_date": obj.get("voucher_date"),
            "voucher_number": obj.get("voucher_number"),
            "voucher_status": obj.get("voucher_status")
        })
        return _obj
