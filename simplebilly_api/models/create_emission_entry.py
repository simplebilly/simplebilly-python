...
class CreateEmissionEntry(BaseModel):
    """
    CreateEmissionEntry
    """ # noqa: E501
    activity_value: StrictStr
    ...
    unit: StrictStr
    year: StrictInt
    __properties: ClassVar[List[str]] = ["activity_value", "category_id", "description", "method", "scope", "unit", "year"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity_value": obj.get("activity_value"),
