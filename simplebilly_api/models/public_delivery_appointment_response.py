...
class PublicDeliveryAppointmentResponse(BaseModel):
    """
    PublicDeliveryAppointmentResponse
    """ # noqa: E501
    appointment_id: StrictStr = Field(alias="appointmentId")
    confirmation_hint: StrictStr = Field(description="Carries the status-check token (email is out of scope for now).", alias="confirmationHint")
    message: StrictStr
    status: StrictStr
    __properties: ClassVar[List[str]] = ["appointmentId", "confirmationHint", "message", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "confirmationHint": obj.get("confirmationHint"),
