...
class BWARevenue(BaseModel):
    """
    BWARevenue
    """ # noqa: E501
    revenue_breakdown: List[RevenueItem]
    total_revenue: StrictStr
    __properties: ClassVar[List[str]] = ["revenue_breakdown", "total_revenue"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in revenue_breakdown (list)
        _items = []
        if self.revenue_breakdown:
            for _item_revenue_breakdown in self.revenue_breakdown:
                _items.append(_item_revenue_breakdown.to_dict() if _item_revenue_breakdown is not None else None)
            _dict['revenue_breakdown'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "revenue_breakdown": [RevenueItem.from_dict(_item) for _item in obj["revenue_breakdown"]] if obj.get("revenue_breakdown") is not None else None,
