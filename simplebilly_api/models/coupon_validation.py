...
class CouponValidation(BaseModel):
    ...
    discount_value: StrictStr
    discounted_amount: StrictStr
    max_discount_amount: Optional[StrictStr] = None
    reason: Optional[StrictStr] = None
    valid: StrictBool
    __properties: ClassVar[List[str]] = ["code", "discount_type", "discount_value", "discounted_amount", "max_discount_amount", "reason", "valid"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.max_discount_amount is None and "max_discount_amount" in self.model_fields_set:
            _dict['max_discount_amount'] = None
