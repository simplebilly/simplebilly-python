...
class PluginErrorOneOf2(BaseModel):
    """
    PluginErrorOneOf2
    """ # noqa: E501
    unauthorized: Annotated[List[Dict[str, Any]], Field(min_length=2, max_length=2)] = Field(alias="Unauthorized")
    __properties: ClassVar[List[str]] = ["Unauthorized"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PluginErrorOneOf2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PluginErrorOneOf2 from a dict"""
        if obj is None:
            return None
