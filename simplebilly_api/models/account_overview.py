...
class AccountOverview(BaseModel):
    ...
    balance: StrictStr
    credit_total: StrictStr
    debit_total: StrictStr
    __properties: ClassVar[List[str]] = ["account", "account_name", "balance", "credit_total", "debit_total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "debit_total": obj.get("debit_total")
        })
        return _obj
