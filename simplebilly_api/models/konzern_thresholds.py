...
class KonzernThresholds(BaseModel):
    """
    KonzernThresholds
    """ # noqa: E501
    bilanzsumme: StrictStr
    mitarbeiter: StrictInt
    netto_umsatz: StrictStr
    __properties: ClassVar[List[str]] = ["bilanzsumme", "mitarbeiter", "netto_umsatz"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "netto_umsatz": obj.get("netto_umsatz")
        })
        return _obj
