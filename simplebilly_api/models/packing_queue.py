...
class PackingQueue(BaseModel):
    """
    PackingQueue
    """ # noqa: E501
    items: List[PackingQueueItem]
    page: Annotated[int, Field(strict=True, ge=0)]
    page_size: Annotated[int, Field(strict=True, ge=0)]
    total_count: Annotated[int, Field(strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["items", "page", "page_size", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [PackingQueueItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "page": obj.get("page"),
