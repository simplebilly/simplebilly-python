...
class GewinnverwendungsZeile(BaseModel):
    """
    GewinnverwendungsZeile
    """ # noqa: E501
    betrag: StrictStr = Field(description="Betrag in EUR (2 Nachkommastellen, als String formatiert).")
    label: StrictStr = Field(description="Deutsche Bezeichnung der Zeile.")
    __properties: ClassVar[List[str]] = ["betrag", "label"]
