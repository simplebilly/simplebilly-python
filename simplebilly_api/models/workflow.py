...
class Workflow(BaseModel):
    ...
    name: StrictStr
    trigger_event: StrictStr = Field(description="Event that triggers the workflow, e.g. `order.paid`, `order.shipped`.", alias="triggerEvent")
    __properties: ClassVar[List[str]] = ["actions", "enabled", "name", "triggerEvent"]
