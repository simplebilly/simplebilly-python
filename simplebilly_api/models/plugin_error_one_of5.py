...
class PluginErrorOneOf5(BaseModel):
    """
    PluginErrorOneOf5
    """ # noqa: E501
    validation_error: Annotated[List[Dict[str, Any]], Field(min_length=2, max_length=2)] = Field(alias="ValidationError")
    __properties: ClassVar[List[str]] = ["ValidationError"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PluginErrorOneOf5 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PluginErrorOneOf5 from a dict"""
        if obj is None:
            return None
