...
class OAuthAuthorizeRequest(BaseModel):
    ...
    """ # noqa: E501
    config: Optional[Any] = Field(default=None, description="Optional platform-specific config (e.g. Shopify `shop_domain`, `api_key`, `api_secret`) needed to build the authorization URL.")
    platform: StrictStr
    redirect_uri: StrictStr
    __properties: ClassVar[List[str]] = ["config", "platform", "redirect_uri"]
