...
class ProposedAssignment(BaseModel):
    ...
    payment_date: StrictStr
    payment_id: UUID
    reason: StrictStr
    reference: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["amount_paid", "confidence", "customer_id", "invoice_id", "invoice_number", "open_amount", "payment_date", "payment_id", "reason", "reference"]
