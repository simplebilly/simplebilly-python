...
class BoxFit(BaseModel):
    """
    BoxFit
    """ # noqa: E501
    height_cm: Union[StrictFloat, StrictInt]
    item_count: Annotated[int, Field(strict=True, ge=0)]
    length_cm: Union[StrictFloat, StrictInt]
    volume_cm3: Union[StrictFloat, StrictInt]
    width_cm: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["height_cm", "item_count", "length_cm", "volume_cm3", "width_cm"]
