...
class NotificationDto(BaseModel):
    ...
    sent_via_email: StrictBool
    tenant_id: UUID
    title: StrictStr
    user_id: UUID
    __properties: ClassVar[List[str]] = ["created_at", "id", "is_read", "message", "sent_via_email", "tenant_id", "title", "user_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sent_via_email": obj.get("sent_via_email"),
