...
class KontoItem(BaseModel):
    """
    KontoItem
    """ # noqa: E501
    anfangsbestand: StrictStr
    haben_umsatz: StrictStr
    konto: StrictStr
    name: StrictStr
    saldo: StrictStr
    soll_umsatz: StrictStr
    __properties: ClassVar[List[str]] = ["anfangsbestand", "haben_umsatz", "konto", "name", "saldo", "soll_umsatz"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "anfangsbestand": obj.get("anfangsbestand"),
            "haben_umsatz": obj.get("haben_umsatz"),
            "konto": obj.get("konto"),
            "name": obj.get("name"),
            "saldo": obj.get("saldo"),
            "soll_umsatz": obj.get("soll_umsatz")
        })
        return _obj
