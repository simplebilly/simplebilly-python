...
class WebhookSubscription(BaseModel):
    ...
    WebhookSubscription
    """ # noqa: E501
    event_type: StrictStr = Field(description="Event type to react to (e.g. \"order.created\"); \"*\" = all events.", alias="eventType")
    is_active: Optional[StrictBool] = Field(default=None, alias="isActive")
    name: StrictStr = Field(description="Human label (e.g. \"Warehouse app\").")
    secret: StrictStr = Field(description="Shared secret for HMAC-SHA256 signature, sent as X-Signature.")
    url: StrictStr
    __properties: ClassVar[List[str]] = ["eventType", "isActive", "name", "secret", "url"]
