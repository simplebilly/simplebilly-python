...
class ApiResponseVecUserTenantInfo(BaseModel):
    """
    ApiResponseVecUserTenantInfo
    """ # noqa: E501
    data: Optional[List[ApiResponseVecUserTenantInfoDataInner]] = None
    error: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    success: StrictBool
    __properties: ClassVar[List[str]] = ["data", "error", "message", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ApiResponseVecUserTenantInfoDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "error": obj.get("error"),
