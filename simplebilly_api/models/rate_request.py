...
class RateRequest(BaseModel):
    ...
    recipient: Address
    sender: Address
    __properties: ClassVar[List[str]] = ["customer", "packages", "recipient", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customer": CustomerInfo.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
