...
class PublicReturnRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["email", "items", "notes", "orderNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": obj.get("email"),
            "items": [PublicReturnItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "notes": obj.get("notes"),
