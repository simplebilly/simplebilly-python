...
class PosTableCreate(BaseModel):
    ...
    PosTableCreate
    """ # noqa: E501
    current_order_number: Optional[StrictStr] = Field(default=None, alias="currentOrderNumber")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=50)]
    status: Optional[PosTableStatus] = None
    __properties: ClassVar[List[str]] = ["currentOrderNumber", "name", "status"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if current_order_number (nullable) is None
        # and model_fields_set contains the field
        if self.current_order_number is None and "current_order_number" in self.model_fields_set:
            _dict['currentOrderNumber'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currentOrderNumber": obj.get("currentOrderNumber"),
            "name": obj.get("name"),
