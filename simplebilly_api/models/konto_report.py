...
class KontoReport(BaseModel):
    ...
    period: StrictStr
    __properties: ClassVar[List[str]] = ["generated_at", "konten", "period"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in konten (list)
        _items = []
        if self.konten:
            for _item_konten in self.konten:
                _items.append(_item_konten.to_dict() if _item_konten is not None else None)
            _dict['konten'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "konten": [KontoItem.from_dict(_item) for _item in obj["konten"]] if obj.get("konten") is not None else None,
