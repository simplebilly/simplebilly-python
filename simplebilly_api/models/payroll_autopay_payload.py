...
class PayrollAutopayPayload(BaseModel):
    """
    PayrollAutopayPayload
    """ # noqa: E501
    debtor_bic: Optional[StrictStr] = None
    debtor_iban: Optional[StrictStr] = None
    debtor_name: Optional[StrictStr] = None
    execution_date: Optional[date] = None
    __properties: ClassVar[List[str]] = ["debtor_bic", "debtor_iban", "debtor_name", "execution_date"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if debtor_bic (nullable) is None
        # and model_fields_set contains the field
        if self.debtor_bic is None and "debtor_bic" in self.model_fields_set:
            _dict['debtor_bic'] = None
