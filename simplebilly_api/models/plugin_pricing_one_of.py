...
class PluginPricingOneOf(BaseModel):
    """
    PluginPricingOneOf
    """ # noqa: E501
    type: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['free']):
            raise ValueError("must be one of enum values ('free')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PluginPricingOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PluginPricingOneOf from a dict"""
        if obj is None:
            return None
