...
class OssReport(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dependencies", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dependencies": [OssDependency.from_dict(_item) for _item in obj["dependencies"]] if obj.get("dependencies") is not None else None,
