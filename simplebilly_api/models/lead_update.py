...
class LeadUpdate(BaseModel):
    ...
    first_contact_at: Optional[datetime] = Field(default=None, alias="firstContactAt")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if first_contact_at (nullable) is None
        # and model_fields_set contains the field
        if self.first_contact_at is None and "first_contact_at" in self.model_fields_set:
            _dict['firstContactAt'] = None
