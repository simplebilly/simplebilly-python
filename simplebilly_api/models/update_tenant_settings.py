...
class UpdateTenantSettings(BaseModel):
    ...
    features: Optional[PartialFeatureSettings] = None
    __properties: ClassVar[List[str]] = ["companyType", "features"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "features": PartialFeatureSettings.from_dict(obj["features"]) if obj.get("features") is not None else None
        })
        return _obj
