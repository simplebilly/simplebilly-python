...
class PaymentGateway(BaseModel):
    ...
    gateway_type: GatewayType = Field(alias="gatewayType")
    label: StrictStr
    tenant_id: UUID = Field(alias="tenantId")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["config", "createdAt", "deletedAt", "enabled", "gatewayId", "gatewayType", "label", "tenantId", "updatedAt"]
