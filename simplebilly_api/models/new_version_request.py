...
class NewVersionRequest(BaseModel):
    ...
    """ # noqa: E501
    file_name: StrictStr = Field(description="Storage key of the already-uploaded bytes.", alias="fileName")
    ...
    __properties: ClassVar[List[str]] = ["fileName", "fileSize", "mimeType", "originalName", "sha256Hash"]
