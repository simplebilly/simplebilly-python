...
class TrackOrderResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["order_number", "order_status", "shipments"]
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.shipments:
            for _item_shipments in self.shipments:
                _items.append(_item_shipments.to_dict() if _item_shipments is not None else None)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shipments": [TrackedShipment.from_dict(_item) for _item in obj["shipments"]] if obj.get("shipments") is not None else None
        })
        return _obj
