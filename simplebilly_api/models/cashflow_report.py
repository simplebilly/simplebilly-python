...
class CashflowReport(BaseModel):
    ...
    CashflowReport
    """ # noqa: E501
    closing_balance: Union[StrictFloat, StrictInt]
    financing_cashflow: Union[StrictFloat, StrictInt]
    investing_cashflow: Union[StrictFloat, StrictInt]
    net_cashflow: Union[StrictFloat, StrictInt]
    opening_balance: Union[StrictFloat, StrictInt]
    operating_cashflow: Union[StrictFloat, StrictInt]
    period: StrictStr
    __properties: ClassVar[List[str]] = ["closing_balance", "financing_cashflow", "investing_cashflow", "net_cashflow", "opening_balance", "operating_cashflow", "period"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "financing_cashflow": obj.get("financing_cashflow"),
            "investing_cashflow": obj.get("investing_cashflow"),
            "net_cashflow": obj.get("net_cashflow"),
            "opening_balance": obj.get("opening_balance"),
            "operating_cashflow": obj.get("operating_cashflow"),
