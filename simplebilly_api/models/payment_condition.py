...
class PaymentCondition(BaseModel):
    ...
    PaymentCondition
    """ # noqa: E501
    discount_days: StrictInt
    discount_percentage: Union[StrictFloat, StrictInt]
    id: StrictStr
    name: StrictStr
    payment_term_days: StrictInt
    __properties: ClassVar[List[str]] = ["discount_days", "discount_percentage", "id", "name", "payment_term_days"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "payment_term_days": obj.get("payment_term_days")
        })
        return _obj
