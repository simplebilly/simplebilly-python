...
class Verfahrensdokumentation(BaseModel):
    """
    ...
    title: StrictStr
    version: StrictStr
    __properties: ClassVar[List[str]] = ["entries", "generated_at", "title", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [ComplianceEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
