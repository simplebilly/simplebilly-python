...
class EksMonatsWert(BaseModel):
    ...
    ergebnis: StrictStr
    monat: StrictStr
    __properties: ClassVar[List[str]] = ["ausgaben", "einnahmen", "ergebnis", "monat"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ausgaben": obj.get("ausgaben"),
            "einnahmen": obj.get("einnahmen"),
            "ergebnis": obj.get("ergebnis"),
            "monat": obj.get("monat")
        })
        return _obj
