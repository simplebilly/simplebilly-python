...
class UsageSnapshot(BaseModel):
    ...
    """ # noqa: E501
    connectors: StrictInt
    invoices_this_month: StrictInt = Field(alias="invoicesThisMonth")
    overage_seats: StrictInt = Field(alias="overageSeats")
    users: StrictInt
    __properties: ClassVar[List[str]] = ["connectors", "invoicesThisMonth", "overageSeats", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoicesThisMonth": obj.get("invoicesThisMonth"),
            "overageSeats": obj.get("overageSeats"),
            "users": obj.get("users")
        })
        return _obj
