...
class PaymentGatewayUpdate(BaseModel):
    ...
    gateway_type: Optional[GatewayType] = Field(default=None, alias="gatewayType")
    label: Optional[StrictStr] = None
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["config", "createdAt", "deletedAt", "enabled", "gatewayType", "label", "updatedAt"]
