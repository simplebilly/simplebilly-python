...
class PlausibilitySummary(BaseModel):
    ...
    PlausibilitySummary
    """ # noqa: E501
    errors: Annotated[int, Field(strict=True, ge=0)]
    overall_status: CheckStatus
    passed: Annotated[int, Field(strict=True, ge=0)]
    total_checks: Annotated[int, Field(strict=True, ge=0)]
    warnings: Annotated[int, Field(strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["errors", "overall_status", "passed", "total_checks", "warnings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total_checks": obj.get("total_checks"),
