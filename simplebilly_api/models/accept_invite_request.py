...
class AcceptInviteRequest(BaseModel):
    ...
    last_name: StrictStr
    password: StrictStr
    privacy_accepted: StrictBool = Field(description="GDPR consent — rejected unless true.")
    token: StrictStr
    __properties: ClassVar[List[str]] = ["first_name", "last_name", "password", "privacy_accepted", "token"]
