...
class BankLookup(BaseModel):
    ...
    iban: StrictStr
    nextgenpsd2_url: Optional[StrictStr] = None
    psd2_supported: StrictBool
    __properties: ClassVar[List[str]] = ["bank_name", "bic", "iban", "nextgenpsd2_url", "psd2_supported"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if nextgenpsd2_url (nullable) is None
        # and model_fields_set contains the field
        if self.nextgenpsd2_url is None and "nextgenpsd2_url" in self.model_fields_set:
            _dict['nextgenpsd2_url'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bic": obj.get("bic"),
            "iban": obj.get("iban"),
            "nextgenpsd2_url": obj.get("nextgenpsd2_url"),
            "psd2_supported": obj.get("psd2_supported")
        })
        return _obj
