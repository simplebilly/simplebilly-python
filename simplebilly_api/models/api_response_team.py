...
class ApiResponseTeam(BaseModel):
    """
    ApiResponseTeam
    """ # noqa: E501
    data: Optional[ApiResponseTeamData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ApiResponseTeamData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
