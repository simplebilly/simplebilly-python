...
class BudgetGoalRequest(BaseModel):
    ...
    BudgetGoalRequest
    """ # noqa: E501
    monthly_goal: StrictStr = Field(description="Monthly goal amount (gross). 0 means \"no goal\" (fallback to default).")
    year: StrictInt = Field(description="Budget year the goal applies to.")
    __properties: ClassVar[List[str]] = ["monthly_goal", "year"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "monthly_goal": obj.get("monthly_goal"),
            "year": obj.get("year")
        })
        return _obj
