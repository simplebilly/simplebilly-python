...
class PrintLabelResponse(BaseModel):
    ...
    message: StrictStr
    sscc: Optional[StrictStr] = None
    success: StrictBool
    tracking_number: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["label_url", "message", "sscc", "success", "tracking_number"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sscc (nullable) is None
        # and model_fields_set contains the field
        if self.sscc is None and "sscc" in self.model_fields_set:
            _dict['sscc'] = None
