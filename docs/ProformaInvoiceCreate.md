...
json = "{}"
# create an instance of ProformaInvoiceCreate from a JSON string
proforma_invoice_create_instance = ProformaInvoiceCreate.from_json(json)
# print the JSON string representation of the object
print(ProformaInvoiceCreate.to_json())

# convert the object into a dict
proforma_invoice_create_dict = proforma_invoice_create_instance.to_dict()
# create an instance of ProformaInvoiceCreate from a dict
proforma_invoice_create_from_dict = ProformaInvoiceCreate.from_dict(proforma_invoice_create_dict)
```
