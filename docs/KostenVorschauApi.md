# simplebilly_api.KostenVorschauApi
...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    api_instance = simplebilly_api.KostenVorschauApi(api_client)
    year = 56 # int | 
    month = 56 # int | 

    try:
        api_response = api_instance.kosten_vorschau_api(year, month)
        print("The response of KostenVorschauApi->kosten_vorschau_api:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KostenVorschauApi->kosten_vorschau_api: %s\n" % e)
```
