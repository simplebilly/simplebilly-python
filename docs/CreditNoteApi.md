...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    api_instance = simplebilly_api.CreditNoteApi(api_client)
    body = None # object | 

    try:
        api_response = api_instance.create_credit_note(body)
...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CreditNoteApi->download_credit_note_pdf: %s\n" % e)
```
...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CreditNoteApi->get_credit_note:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CreditNoteApi->get_credit_note: %s\n" % e)
```
...
# **list_credit_notes**
> List[Invoice] list_credit_notes(page=page, page_size=page_size, search=search, include_deleted=include_deleted)
...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.list_credit_notes(page=page, page_size=page_size, search=search, include_deleted=include_deleted)
        print("The response of CreditNoteApi->list_credit_notes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CreditNoteApi->list_credit_notes: %s\n" % e)
```
