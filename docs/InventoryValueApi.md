# simplebilly_api.InventoryValueApi
...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    api_instance = simplebilly_api.InventoryValueApi(api_client)

    try:
        api_response = api_instance.get_inventory_value_api()
        print("The response of InventoryValueApi->get_inventory_value_api:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InventoryValueApi->get_inventory_value_api: %s\n" % e)
```
...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.record_inventory_value_api()
        print("The response of InventoryValueApi->record_inventory_value_api:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InventoryValueApi->record_inventory_value_api: %s\n" % e)
```
