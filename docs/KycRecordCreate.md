...
kyc_record_create_instance = KycRecordCreate.from_json(json)
# print the JSON string representation of the object
print(KycRecordCreate.to_json())

# convert the object into a dict
kyc_record_create_dict = kyc_record_create_instance.to_dict()
# create an instance of KycRecordCreate from a dict
kyc_record_create_from_dict = KycRecordCreate.from_dict(kyc_record_create_dict)
```
