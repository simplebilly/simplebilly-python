...
json = "{}"
# create an instance of OrderConfirmation from a JSON string
order_confirmation_instance = OrderConfirmation.from_json(json)
# print the JSON string representation of the object
print(OrderConfirmation.to_json())

# convert the object into a dict
order_confirmation_dict = order_confirmation_instance.to_dict()
# create an instance of OrderConfirmation from a dict
order_confirmation_from_dict = OrderConfirmation.from_dict(order_confirmation_dict)
```
