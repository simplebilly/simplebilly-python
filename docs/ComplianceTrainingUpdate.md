...
compliance_training_update_instance = ComplianceTrainingUpdate.from_json(json)
# print the JSON string representation of the object
print(ComplianceTrainingUpdate.to_json())

# convert the object into a dict
compliance_training_update_dict = compliance_training_update_instance.to_dict()
# create an instance of ComplianceTrainingUpdate from a dict
compliance_training_update_from_dict = ComplianceTrainingUpdate.from_dict(compliance_training_update_dict)
```
