# simplebilly_api.DatevImportApi
...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    api_instance = simplebilly_api.DatevImportApi(api_client)
    body = None # object | 

    try:
        api_response = api_instance.datev_import_api(body)
        print("The response of DatevImportApi->datev_import_api:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DatevImportApi->datev_import_api: %s\n" % e)
```
