...
json = "{}"
# create an instance of SupplierCondition from a JSON string
supplier_condition_instance = SupplierCondition.from_json(json)
# print the JSON string representation of the object
print(SupplierCondition.to_json())

# convert the object into a dict
supplier_condition_dict = supplier_condition_instance.to_dict()
# create an instance of SupplierCondition from a dict
supplier_condition_from_dict = SupplierCondition.from_dict(supplier_condition_dict)
```
