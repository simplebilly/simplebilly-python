...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    api_instance = simplebilly_api.AnlageGApi(api_client)
    year = 56 # int | 

    try:
        api_response = api_instance.anlage_g_api(year)
        print("The response of AnlageGApi->anlage_g_api:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AnlageGApi->anlage_g_api: %s\n" % e)
```
