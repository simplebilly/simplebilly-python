...
json = "{}"
# create an instance of ServiceAssignmentCreate from a JSON string
service_assignment_create_instance = ServiceAssignmentCreate.from_json(json)
# print the JSON string representation of the object
print(ServiceAssignmentCreate.to_json())

# convert the object into a dict
service_assignment_create_dict = service_assignment_create_instance.to_dict()
# create an instance of ServiceAssignmentCreate from a dict
service_assignment_create_from_dict = ServiceAssignmentCreate.from_dict(service_assignment_create_dict)
```
