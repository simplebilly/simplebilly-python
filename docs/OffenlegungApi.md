# simplebilly_api.OffenlegungApi
...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    api_instance = simplebilly_api.OffenlegungApi(api_client)

    try:
        api_response = api_instance.offenlegung_api()
        print("The response of OffenlegungApi->offenlegung_api:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OffenlegungApi->offenlegung_api: %s\n" % e)
```
