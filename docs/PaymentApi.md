...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    api_instance = simplebilly_api.PaymentApi(api_client)
    payment_create = simplebilly_api.PaymentCreate() # PaymentCreate | 

    try:
        api_response = api_instance.create_payment(payment_create)
        print("The response of PaymentApi->create_payment:\n")
        pprint(api_response)
...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PaymentApi->get_payment:\n")
        pprint(api_response)
    except Exception as e:
...
# **get_payments**
> List[Payment] get_payments(page=page, page_size=page_size, search=search, include_deleted=include_deleted)
...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_payments(page=page, page_size=page_size, search=search, include_deleted=include_deleted)
...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.payment_restore(id)
        print("The response of PaymentApi->payment_restore:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentApi->payment_restore: %s\n" % e)
```
...
with simplebilly_api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.update_payment(id, body)
