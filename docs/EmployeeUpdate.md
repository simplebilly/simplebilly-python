...
employee_update_instance = EmployeeUpdate.from_json(json)
# print the JSON string representation of the object
print(EmployeeUpdate.to_json())

# convert the object into a dict
employee_update_dict = employee_update_instance.to_dict()
# create an instance of EmployeeUpdate from a dict
employee_update_from_dict = EmployeeUpdate.from_dict(employee_update_dict)
```
