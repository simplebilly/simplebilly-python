...
shareholder_instance = Shareholder.from_json(json)
# print the JSON string representation of the object
print(Shareholder.to_json())

# convert the object into a dict
shareholder_dict = shareholder_instance.to_dict()
# create an instance of Shareholder from a dict
shareholder_from_dict = Shareholder.from_dict(shareholder_dict)
```
