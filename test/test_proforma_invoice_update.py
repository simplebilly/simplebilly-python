...
class TestProformaInvoiceUpdate(unittest.TestCase):
    """ProformaInvoiceUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProformaInvoiceUpdate:
        """Test ProformaInvoiceUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProformaInvoiceUpdate`
        """
        model = ProformaInvoiceUpdate()
        if include_optional:
    ...
    def testProformaInvoiceUpdate(self):
        """Test ProformaInvoiceUpdate"""
