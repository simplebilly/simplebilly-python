...
class TestAnlageGKfzHinweis(unittest.TestCase):
    """AnlageGKfzHinweis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnlageGKfzHinweis:
        """Test AnlageGKfzHinweis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnlageGKfzHinweis`
        """
        model = AnlageGKfzHinweis()
        if include_optional:
    ...
    def testAnlageGKfzHinweis(self):
        """Test AnlageGKfzHinweis"""
