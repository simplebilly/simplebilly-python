...
class TestOrderStateUpdate(unittest.TestCase):
    """OrderStateUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderStateUpdate:
        """Test OrderStateUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderStateUpdate`
        """
        model = OrderStateUpdate()
        if include_optional:
            return OrderStateUpdate(
                send_state_to_shop = True,
                state = ''
            )
        else:
            return OrderStateUpdate(
