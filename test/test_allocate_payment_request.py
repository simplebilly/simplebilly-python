...
class TestAllocatePaymentRequest(unittest.TestCase):
    """AllocatePaymentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AllocatePaymentRequest:
        """Test AllocatePaymentRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllocatePaymentRequest`
        """
        model = AllocatePaymentRequest()
        if include_optional:
    ...
    def testAllocatePaymentRequest(self):
        """Test AllocatePaymentRequest"""
