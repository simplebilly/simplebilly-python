...
class TestServiceAssignmentStatus(unittest.TestCase):
    """ServiceAssignmentStatus unit test stubs"""
    ...
    def testServiceAssignmentStatus(self):
        """Test ServiceAssignmentStatus"""
        # inst = ServiceAssignmentStatus()
