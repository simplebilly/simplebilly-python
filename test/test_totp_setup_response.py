...
class TestTotpSetupResponse(unittest.TestCase):
    """TotpSetupResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TotpSetupResponse:
        """Test TotpSetupResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TotpSetupResponse`
        """
        model = TotpSetupResponse()
        if include_optional:
    ...
    def testTotpSetupResponse(self):
        """Test TotpSetupResponse"""
