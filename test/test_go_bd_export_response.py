...
class TestGoBDExportResponse(unittest.TestCase):
    """GoBDExportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoBDExportResponse:
        """Test GoBDExportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoBDExportResponse`
        """
        model = GoBDExportResponse()
        if include_optional:
    ...
    def testGoBDExportResponse(self):
        """Test GoBDExportResponse"""
