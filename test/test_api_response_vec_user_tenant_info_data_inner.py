...
class TestApiResponseVecUserTenantInfoDataInner(unittest.TestCase):
    """ApiResponseVecUserTenantInfoDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseVecUserTenantInfoDataInner:
        """Test ApiResponseVecUserTenantInfoDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseVecUserTenantInfoDataInner`
        """
        model = ApiResponseVecUserTenantInfoDataInner()
        if include_optional:
    ...
    def testApiResponseVecUserTenantInfoDataInner(self):
        """Test ApiResponseVecUserTenantInfoDataInner"""
