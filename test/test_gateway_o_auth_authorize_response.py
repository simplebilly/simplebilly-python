...
class TestGatewayOAuthAuthorizeResponse(unittest.TestCase):
    """GatewayOAuthAuthorizeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GatewayOAuthAuthorizeResponse:
        """Test GatewayOAuthAuthorizeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GatewayOAuthAuthorizeResponse`
        """
        model = GatewayOAuthAuthorizeResponse()
        if include_optional:
    ...
    def testGatewayOAuthAuthorizeResponse(self):
        """Test GatewayOAuthAuthorizeResponse"""
