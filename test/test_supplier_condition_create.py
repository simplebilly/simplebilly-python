...
class TestSupplierConditionCreate(unittest.TestCase):
    """SupplierConditionCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupplierConditionCreate:
        """Test SupplierConditionCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupplierConditionCreate`
        """
        model = SupplierConditionCreate()
        if include_optional:
    ...
    def testSupplierConditionCreate(self):
        """Test SupplierConditionCreate"""
