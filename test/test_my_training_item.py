...
class TestMyTrainingItem(unittest.TestCase):
    """MyTrainingItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MyTrainingItem:
        """Test MyTrainingItem
