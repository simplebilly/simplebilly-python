...
class TestShipmentStatusUpdate(unittest.TestCase):
    """ShipmentStatusUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShipmentStatusUpdate:
    ...
    def testShipmentStatusUpdate(self):
        """Test ShipmentStatusUpdate"""
