...
class TestKycRecordCreate(unittest.TestCase):
    """KycRecordCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KycRecordCreate:
        """Test KycRecordCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KycRecordCreate`
        """
        model = KycRecordCreate()
        if include_optional:
            return KycRecordCreate(
                customer_id = '',
                customer_name = '0',
                kyc_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                notes = '',
                retention_until = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                risk_assessment = ''
            )
        else:
            return KycRecordCreate(
