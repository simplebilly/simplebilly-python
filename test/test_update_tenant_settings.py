...
class TestUpdateTenantSettings(unittest.TestCase):
    """UpdateTenantSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateTenantSettings:
        """Test UpdateTenantSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTenantSettings`
        """
        model = UpdateTenantSettings()
        if include_optional:
            return UpdateTenantSettings(
                company_type = 'gmbh',
                features = simplebilly_api.models.partial_feature_settings.PartialFeatureSettings(
                    onlineshop = True, 
                    report_bilanz = True, 
                    report_bwa = True, 
                    report_euer = True, 
    ...
    def testUpdateTenantSettings(self):
        """Test UpdateTenantSettings"""
