...
class TestInstituteCheckItem(unittest.TestCase):
    """InstituteCheckItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstituteCheckItem:
        """Test InstituteCheckItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstituteCheckItem`
        """
        model = InstituteCheckItem()
        if include_optional:
    ...
    def testInstituteCheckItem(self):
        """Test InstituteCheckItem"""
