...
class TestPaygapApi(unittest.TestCase):
    """PaygapApi unit test stubs"""
    ...
    def test_paygap_auskunft_api(self) -> None:
        """Test case for paygap_auskunft_api

        """
        pass

    def test_paygap_export_api(self) -> None:
        """Test case for paygap_export_api

        """
        pass

    def test_paygap_report_api(self) -> None:
        """Test case for paygap_report_api
