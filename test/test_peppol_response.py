...
class TestPeppolResponse(unittest.TestCase):
    """PeppolResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PeppolResponse:
        """Test PeppolResponse
