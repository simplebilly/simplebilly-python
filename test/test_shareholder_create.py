...
class TestShareholderCreate(unittest.TestCase):
    """ShareholderCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShareholderCreate:
        """Test ShareholderCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShareholderCreate`
        """
        model = ShareholderCreate()
        if include_optional:
            return ShareholderCreate(
                address = '0',
    ...
    def testShareholderCreate(self):
        """Test ShareholderCreate"""
