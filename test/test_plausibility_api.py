...
class TestPlausibilityApi(unittest.TestCase):
    """PlausibilityApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PlausibilityApi()

    def tearDown(self) -> None:
        pass

    def test_plausibility_check_api(self) -> None:
        """Test case for plausibility_check_api
