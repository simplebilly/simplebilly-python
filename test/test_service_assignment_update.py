...
class TestServiceAssignmentUpdate(unittest.TestCase):
    """ServiceAssignmentUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceAssignmentUpdate:
        """Test ServiceAssignmentUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceAssignmentUpdate`
        """
        model = ServiceAssignmentUpdate()
        if include_optional:
    ...
    def testServiceAssignmentUpdate(self):
        """Test ServiceAssignmentUpdate"""
