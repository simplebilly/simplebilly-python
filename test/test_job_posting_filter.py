...
class TestJobPostingFilter(unittest.TestCase):
    """JobPostingFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobPostingFilter:
        """Test JobPostingFilter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobPostingFilter`
        """
        model = JobPostingFilter()
        if include_optional:
