...
class TestDpaAcceptRequest(unittest.TestCase):
    """DpaAcceptRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DpaAcceptRequest:
        """Test DpaAcceptRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DpaAcceptRequest`
        """
        model = DpaAcceptRequest()
        if include_optional:
