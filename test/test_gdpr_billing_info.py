...
class TestGdprBillingInfo(unittest.TestCase):
    """GdprBillingInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GdprBillingInfo:
        """Test GdprBillingInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GdprBillingInfo`
        """
        model = GdprBillingInfo()
        if include_optional:
