...
class TestShippingRuleCreate(unittest.TestCase):
    """ShippingRuleCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingRuleCreate:
        """Test ShippingRuleCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingRuleCreate`
        """
        model = ShippingRuleCreate()
        if include_optional:
    ...
    def testShippingRuleCreate(self):
        """Test ShippingRuleCreate"""
