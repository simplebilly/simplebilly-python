...
class TestPublicReturnRequest(unittest.TestCase):
    """PublicReturnRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicReturnRequest:
        """Test PublicReturnRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicReturnRequest`
        """
        model = PublicReturnRequest()
        if include_optional:
            return PublicReturnRequest(
                email = '',
                items = [
                    simplebilly_api.models.public_return_item.PublicReturnItem(
                        name = '', 
                        product_id = '', 
                        quantity = 56, 
                        reason = '', )
    ...
    def testPublicReturnRequest(self):
        """Test PublicReturnRequest"""
