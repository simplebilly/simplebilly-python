...
class TestPackingCompleteRequest(unittest.TestCase):
    """PackingCompleteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PackingCompleteRequest:
        """Test PackingCompleteRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PackingCompleteRequest`
        """
        model = PackingCompleteRequest()
        if include_optional:
    ...
    def testPackingCompleteRequest(self):
        """Test PackingCompleteRequest"""
