...
class TestBomCreate(unittest.TestCase):
    """BomCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BomCreate:
        """Test BomCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BomCreate`
        """
        model = BomCreate()
        if include_optional:
            return BomCreate(
