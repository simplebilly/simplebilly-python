...
class TestImportTestRequest(unittest.TestCase):
    """ImportTestRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportTestRequest:
        """Test ImportTestRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportTestRequest`
        """
        model = ImportTestRequest()
        if include_optional:
            return ImportTestRequest(
                api_key = '',
                provider = ''
            )
        else:
    ...
    def testImportTestRequest(self):
        """Test ImportTestRequest"""
