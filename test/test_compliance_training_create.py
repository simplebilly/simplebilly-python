...
class TestComplianceTrainingCreate(unittest.TestCase):
    """ComplianceTrainingCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComplianceTrainingCreate:
        """Test ComplianceTrainingCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComplianceTrainingCreate`
        """
        model = ComplianceTrainingCreate()
        if include_optional:
    ...
    def testComplianceTrainingCreate(self):
        """Test ComplianceTrainingCreate"""
