...
class TestOcrTextRequest(unittest.TestCase):
    """OcrTextRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OcrTextRequest:
        """Test OcrTextRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OcrTextRequest`
        """
        model = OcrTextRequest()
        if include_optional:
