...
class TestRfqUpdate(unittest.TestCase):
    """RfqUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RfqUpdate:
        """Test RfqUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RfqUpdate`
        """
        model = RfqUpdate()
        if include_optional:
            return RfqUpdate(
