...
class TestGatewayOAuthAuthorizeRequest(unittest.TestCase):
    """GatewayOAuthAuthorizeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GatewayOAuthAuthorizeRequest:
        """Test GatewayOAuthAuthorizeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GatewayOAuthAuthorizeRequest`
        """
        model = GatewayOAuthAuthorizeRequest()
        if include_optional:
    ...
    def testGatewayOAuthAuthorizeRequest(self):
        """Test GatewayOAuthAuthorizeRequest"""
