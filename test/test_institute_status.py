...
class TestInstituteStatus(unittest.TestCase):
    """InstituteStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstituteStatus:
        """Test InstituteStatus
        ...
        if include_optional:
            return InstituteStatus(
                checklist = [
                    simplebilly_api.models.institute_check_item.InstituteCheckItem(
                        exists = True, 
                        name = '', 
                        source = '', )
                    ],
                deadlines = simplebilly_api.models.institute_deadlines.InstituteDeadlines(
