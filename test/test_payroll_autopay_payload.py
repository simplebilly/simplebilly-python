...
class TestPayrollAutopayPayload(unittest.TestCase):
    """PayrollAutopayPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayrollAutopayPayload:
        """Test PayrollAutopayPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayrollAutopayPayload`
        """
        model = PayrollAutopayPayload()
        if include_optional:
    ...
    def testPayrollAutopayPayload(self):
        """Test PayrollAutopayPayload"""
