...
class TestJobPostingUpdate(unittest.TestCase):
    """JobPostingUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobPostingUpdate:
        """Test JobPostingUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobPostingUpdate`
        """
        model = JobPostingUpdate()
        if include_optional:
