...
class TestGenerateCountRequest(unittest.TestCase):
    """GenerateCountRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateCountRequest:
        """Test GenerateCountRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateCountRequest`
        """
        model = GenerateCountRequest()
        if include_optional:
    ...
    def testGenerateCountRequest(self):
        """Test GenerateCountRequest"""
