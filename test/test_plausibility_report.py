...
class TestPlausibilityReport(unittest.TestCase):
    """PlausibilityReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlausibilityReport:
        """Test PlausibilityReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlausibilityReport`
        """
        model = PlausibilityReport()
        if include_optional:
            return PlausibilityReport(
                checks = [
                    simplebilly_api.models.plausibility_check.PlausibilityCheck(
                        detail = '', 
                        id = '', 
                        name = '', 
                        severity = 'Info', 
                ...
                generated_at = '',
                summary = simplebilly_api.models.plausibility_summary.PlausibilitySummary(
                    errors = 0, 
                    overall_status = 'Ok', 
                    passed = 0, 
                    total_checks = 0, 
    ...
    def testPlausibilityReport(self):
        """Test PlausibilityReport"""
