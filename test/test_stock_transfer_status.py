...
class TestStockTransferStatus(unittest.TestCase):
    """StockTransferStatus unit test stubs"""
    ...
    def testStockTransferStatus(self):
        """Test StockTransferStatus"""
        # inst = StockTransferStatus()
