...
class TestProformaInvoiceCreate(unittest.TestCase):
    """ProformaInvoiceCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProformaInvoiceCreate:
        """Test ProformaInvoiceCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProformaInvoiceCreate`
        """
        model = ProformaInvoiceCreate()
        if include_optional:
    ...
    def testProformaInvoiceCreate(self):
        """Test ProformaInvoiceCreate"""
