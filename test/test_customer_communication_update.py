...
class TestCustomerCommunicationUpdate(unittest.TestCase):
    """CustomerCommunicationUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerCommunicationUpdate:
        """Test CustomerCommunicationUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerCommunicationUpdate`
        """
        model = CustomerCommunicationUpdate()
        if include_optional:
    ...
    def testCustomerCommunicationUpdate(self):
        """Test CustomerCommunicationUpdate"""
