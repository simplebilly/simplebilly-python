...
class TestPublicReturnStatusResponse(unittest.TestCase):
    """PublicReturnStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicReturnStatusResponse:
        """Test PublicReturnStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicReturnStatusResponse`
        """
        model = PublicReturnStatusResponse()
        if include_optional:
    ...
    def testPublicReturnStatusResponse(self):
        """Test PublicReturnStatusResponse"""
