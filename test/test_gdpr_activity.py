...
class TestGdprActivity(unittest.TestCase):
    """GdprActivity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GdprActivity:
        """Test GdprActivity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GdprActivity`
        """
        model = GdprActivity()
        if include_optional:
            return GdprActivity(
