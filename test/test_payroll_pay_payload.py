...
class TestPayrollPayPayload(unittest.TestCase):
    """PayrollPayPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayrollPayPayload:
        """Test PayrollPayPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayrollPayPayload`
        """
        model = PayrollPayPayload()
        if include_optional:
            return PayrollPayPayload(
    ...
    def testPayrollPayPayload(self):
        """Test PayrollPayPayload"""
