...
class TestTimeEntryClockOut(unittest.TestCase):
    """TimeEntryClockOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeEntryClockOut:
        """Test TimeEntryClockOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeEntryClockOut`
        """
        model = TimeEntryClockOut()
        if include_optional:
    ...
    def testTimeEntryClockOut(self):
        """Test TimeEntryClockOut"""
