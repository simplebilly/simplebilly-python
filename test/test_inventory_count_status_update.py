...
class TestInventoryCountStatusUpdate(unittest.TestCase):
    """InventoryCountStatusUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryCountStatusUpdate:
        """Test InventoryCountStatusUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryCountStatusUpdate`
        """
        model = InventoryCountStatusUpdate()
        if include_optional:
            return InventoryCountStatusUpdate(
                status = ''
            )
        else:
            return InventoryCountStatusUpdate(
    ...
    def testInventoryCountStatusUpdate(self):
        """Test InventoryCountStatusUpdate"""
