...
class TestSubmitResultDto(unittest.TestCase):
    """SubmitResultDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmitResultDto:
        """Test SubmitResultDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubmitResultDto`
        """
        model = SubmitResultDto()
        if include_optional:
