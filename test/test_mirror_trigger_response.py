...
class TestMirrorTriggerResponse(unittest.TestCase):
    """MirrorTriggerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MirrorTriggerResponse:
        """Test MirrorTriggerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MirrorTriggerResponse`
        """
        model = MirrorTriggerResponse()
        if include_optional:
    ...
    def testMirrorTriggerResponse(self):
        """Test MirrorTriggerResponse"""
