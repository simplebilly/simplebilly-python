...
class TestAiApi(unittest.TestCase):
    ...
    def test_ai_suggest_api(self) -> None:
        """Test case for ai_suggest_api

        """
        pass

    def test_create_worker_api(self) -> None:
        """Test case for create_worker_api

        """
        pass

    def test_list_workers_api(self) -> None:
        """Test case for list_workers_api

        """
        pass

    def test_run_worker_api(self) -> None:
        """Test case for run_worker_api
