...
class TestOffenlegungApi(unittest.TestCase):
    """OffenlegungApi unit test stubs"""

    def setUp(self) -> None:
        self.api = OffenlegungApi()

    def tearDown(self) -> None:
        pass

    def test_offenlegung_api(self) -> None:
        """Test case for offenlegung_api
