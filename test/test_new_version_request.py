...
class TestNewVersionRequest(unittest.TestCase):
    """NewVersionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewVersionRequest:
        """Test NewVersionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewVersionRequest`
        """
        model = NewVersionRequest()
        if include_optional:
    ...
    def testNewVersionRequest(self):
        """Test NewVersionRequest"""
