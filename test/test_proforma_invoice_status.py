...
class TestProformaInvoiceStatus(unittest.TestCase):
    """ProformaInvoiceStatus unit test stubs"""
    ...
    def testProformaInvoiceStatus(self):
        """Test ProformaInvoiceStatus"""
        # inst = ProformaInvoiceStatus()
