...
class TestKontoReport(unittest.TestCase):
    """KontoReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KontoReport:
        """Test KontoReport
        ...
        if include_optional:
            return KontoReport(
                generated_at = '',
                konten = [
                    simplebilly_api.models.konto_item.KontoItem(
                        anfangsbestand = '', 
                        haben_umsatz = '', 
                        konto = '', 
                        name = '', 
