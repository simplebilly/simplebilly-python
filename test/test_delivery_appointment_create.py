...
class TestDeliveryAppointmentCreate(unittest.TestCase):
    """DeliveryAppointmentCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliveryAppointmentCreate:
        """Test DeliveryAppointmentCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliveryAppointmentCreate`
        """
        model = DeliveryAppointmentCreate()
        if include_optional:
    ...
    def testDeliveryAppointmentCreate(self):
        """Test DeliveryAppointmentCreate"""
