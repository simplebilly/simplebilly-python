...
class TestPluginErrorOneOf4(unittest.TestCase):
    """PluginErrorOneOf4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PluginErrorOneOf4:
        """Test PluginErrorOneOf4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginErrorOneOf4`
        """
        model = PluginErrorOneOf4()
        if include_optional:
    ...
    def testPluginErrorOneOf4(self):
        """Test PluginErrorOneOf4"""
