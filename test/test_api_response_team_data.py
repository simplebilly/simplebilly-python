...
class TestApiResponseTeamData(unittest.TestCase):
    """ApiResponseTeamData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseTeamData:
        """Test ApiResponseTeamData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseTeamData`
        """
        model = ApiResponseTeamData()
        if include_optional:
    ...
    def testApiResponseTeamData(self):
        """Test ApiResponseTeamData"""
