...
class TestStilleExportResponse(unittest.TestCase):
    """StilleExportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StilleExportResponse:
        """Test StilleExportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StilleExportResponse`
        """
        model = StilleExportResponse()
        if include_optional:
    ...
    def testStilleExportResponse(self):
        """Test StilleExportResponse"""
