...
class TestUpdateSyncDirectionRequest(unittest.TestCase):
    """UpdateSyncDirectionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSyncDirectionRequest:
        """Test UpdateSyncDirectionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSyncDirectionRequest`
        """
        model = UpdateSyncDirectionRequest()
        if include_optional:
            return UpdateSyncDirectionRequest(
                directions = {
                    'key' : ''
                    }
            )
    ...
    def testUpdateSyncDirectionRequest(self):
        """Test UpdateSyncDirectionRequest"""
