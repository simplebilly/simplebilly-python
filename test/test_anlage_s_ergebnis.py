...
class TestAnlageSErgebnis(unittest.TestCase):
    """AnlageSErgebnis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnlageSErgebnis:
        """Test AnlageSErgebnis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnlageSErgebnis`
        """
        model = AnlageSErgebnis()
        if include_optional:
