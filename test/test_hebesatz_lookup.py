...
class TestHebesatzLookup(unittest.TestCase):
    """HebesatzLookup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HebesatzLookup:
        """Test HebesatzLookup
        ...
        if include_optional:
            return HebesatzLookup(
                ...
                gemeinde_name = '',
                gemeindeschluessel = '',
                hebesatz_gewerbesteuer = 1.337,
                hebesatz_grundsteuer_b = 1.337,
                jahr = 56,
                landkreis = '',
                valid_from = '',
                valid_to = ''
