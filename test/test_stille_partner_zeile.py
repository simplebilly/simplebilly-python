...
class TestStillePartnerZeile(unittest.TestCase):
    """StillePartnerZeile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StillePartnerZeile:
        """Test StillePartnerZeile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StillePartnerZeile`
        """
        model = StillePartnerZeile()
        if include_optional:
    ...
    def testStillePartnerZeile(self):
        """Test StillePartnerZeile"""
