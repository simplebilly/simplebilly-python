...
class TestWorkflowEnabledUpdate(unittest.TestCase):
    """WorkflowEnabledUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowEnabledUpdate:
        """Test WorkflowEnabledUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowEnabledUpdate`
        """
        model = WorkflowEnabledUpdate()
        if include_optional:
            return WorkflowEnabledUpdate(
                enabled = True
            )
        else:
            return WorkflowEnabledUpdate(
    ...
    def testWorkflowEnabledUpdate(self):
        """Test WorkflowEnabledUpdate"""
