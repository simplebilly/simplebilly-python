...
class TestPayrollCreatePayload(unittest.TestCase):
    """PayrollCreatePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayrollCreatePayload:
        """Test PayrollCreatePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayrollCreatePayload`
        """
        model = PayrollCreatePayload()
        if include_optional:
            return PayrollCreatePayload(
                ...
                extra_payments = [
                    simplebilly_api.models.extra_payment.ExtraPayment(
                        amount = '', 
                        employee_id = '', 
                        reason = '', )
                    ],
    ...
    def testPayrollCreatePayload(self):
        """Test PayrollCreatePayload"""
