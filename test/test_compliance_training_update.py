...
class TestComplianceTrainingUpdate(unittest.TestCase):
    """ComplianceTrainingUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComplianceTrainingUpdate:
        """Test ComplianceTrainingUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComplianceTrainingUpdate`
        """
        model = ComplianceTrainingUpdate()
        if include_optional:
    ...
    def testComplianceTrainingUpdate(self):
        """Test ComplianceTrainingUpdate"""
