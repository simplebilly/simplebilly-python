...
class TestEuerApi(unittest.TestCase):
    """EuerApi unit test stubs"""
    ...
    def test_euer_api(self) -> None:
        """Test case for euer_api

        """
        pass

    def test_euer_kategorien_api(self) -> None:
        """Test case for euer_kategorien_api
