...
class TestSupplierInvoiceUpdate(unittest.TestCase):
    """SupplierInvoiceUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupplierInvoiceUpdate:
        """Test SupplierInvoiceUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupplierInvoiceUpdate`
        """
        model = SupplierInvoiceUpdate()
        if include_optional:
    ...
    def testSupplierInvoiceUpdate(self):
        """Test SupplierInvoiceUpdate"""
