...
class TestTrainingAssignmentUpdate(unittest.TestCase):
    """TrainingAssignmentUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrainingAssignmentUpdate:
        """Test TrainingAssignmentUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrainingAssignmentUpdate`
        """
        model = TrainingAssignmentUpdate()
        if include_optional:
    ...
    def testTrainingAssignmentUpdate(self):
        """Test TrainingAssignmentUpdate"""
