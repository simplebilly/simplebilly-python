...
class TestTrackOrderRequest(unittest.TestCase):
    """TrackOrderRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrackOrderRequest:
        """Test TrackOrderRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackOrderRequest`
        """
        model = TrackOrderRequest()
        if include_optional:
    ...
    def testTrackOrderRequest(self):
        """Test TrackOrderRequest"""
