...
class TestApiResponseGdprExportData(unittest.TestCase):
    """ApiResponseGdprExportData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseGdprExportData:
        """Test ApiResponseGdprExportData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseGdprExportData`
        """
        model = ApiResponseGdprExportData()
        if include_optional:
    ...
    def testApiResponseGdprExportData(self):
        """Test ApiResponseGdprExportData"""
