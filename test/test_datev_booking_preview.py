...
class TestDatevBookingPreview(unittest.TestCase):
    """DatevBookingPreview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatevBookingPreview:
        """Test DatevBookingPreview
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatevBookingPreview`
        """
        model = DatevBookingPreview()
        if include_optional:
    ...
    def testDatevBookingPreview(self):
        """Test DatevBookingPreview"""
