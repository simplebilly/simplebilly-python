...
class TestRecurringTemplateCreate(unittest.TestCase):
    """RecurringTemplateCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecurringTemplateCreate:
        """Test RecurringTemplateCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecurringTemplateCreate`
        """
        model = RecurringTemplateCreate()
        if include_optional:
    ...
    def testRecurringTemplateCreate(self):
        """Test RecurringTemplateCreate"""
