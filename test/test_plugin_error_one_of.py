...
class TestPluginErrorOneOf(unittest.TestCase):
    """PluginErrorOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PluginErrorOneOf:
        """Test PluginErrorOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginErrorOneOf`
        """
        model = PluginErrorOneOf()
        if include_optional:
