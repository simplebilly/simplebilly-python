...
class TestCurrentInventoryValue(unittest.TestCase):
    """CurrentInventoryValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrentInventoryValue:
        """Test CurrentInventoryValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrentInventoryValue`
        """
        model = CurrentInventoryValue()
        if include_optional:
            return CurrentInventoryValue(
                history = [
                    simplebilly_api.models.inventory_value_point.InventoryValuePoint(
                        product_count = 56, 
    ...
    def testCurrentInventoryValue(self):
        """Test CurrentInventoryValue"""
