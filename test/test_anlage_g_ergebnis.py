...
class TestAnlageGErgebnis(unittest.TestCase):
    """AnlageGErgebnis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnlageGErgebnis:
        """Test AnlageGErgebnis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnlageGErgebnis`
        """
        model = AnlageGErgebnis()
        if include_optional:
            return AnlageGErgebnis(
                gewinn_verlust = '',
                gewst_gezahlt = '',
                gewst_messbetrag_approx = '',
                gewst_pflichtig = True,
                jahr = 56,
                kfz_hinweise = [
                    simplebilly_api.models.anlage_g_kfz_hinweis.AnlageGKfzHinweis(
                        bezeichnung = '', 
                        kennzeichen = '', 
