...
class TestGewinnverwendungsReport(unittest.TestCase):
    """GewinnverwendungsReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GewinnverwendungsReport:
        """Test GewinnverwendungsReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GewinnverwendungsReport`
        """
        model = GewinnverwendungsReport()
        if include_optional:
            return GewinnverwendungsReport(
                ...
                year = 56,
                zeilen = [
                    simplebilly_api.models.gewinnverwendungs_zeile.GewinnverwendungsZeile(
                        betrag = '', 
                        label = '', )
                    ]
            )
    ...
    def testGewinnverwendungsReport(self):
        """Test GewinnverwendungsReport"""
