...
class TestBudgetGoalRequest(unittest.TestCase):
    """BudgetGoalRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BudgetGoalRequest:
        """Test BudgetGoalRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BudgetGoalRequest`
        """
        model = BudgetGoalRequest()
        if include_optional:
    ...
    def testBudgetGoalRequest(self):
        """Test BudgetGoalRequest"""
