...
class TestUpdatePermissionsPayload(unittest.TestCase):
    """UpdatePermissionsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePermissionsPayload:
        """Test UpdatePermissionsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePermissionsPayload`
        """
        model = UpdatePermissionsPayload()
        if include_optional:
    ...
    def testUpdatePermissionsPayload(self):
        """Test UpdatePermissionsPayload"""
