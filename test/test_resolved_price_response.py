...
class TestResolvedPriceResponse(unittest.TestCase):
    """ResolvedPriceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResolvedPriceResponse:
        """Test ResolvedPriceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResolvedPriceResponse`
        """
        model = ResolvedPriceResponse()
        if include_optional:
    ...
    def testResolvedPriceResponse(self):
        """Test ResolvedPriceResponse"""
