...
class TestPluginErrorOneOf5(unittest.TestCase):
    """PluginErrorOneOf5 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PluginErrorOneOf5:
        """Test PluginErrorOneOf5
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginErrorOneOf5`
        """
        model = PluginErrorOneOf5()
        if include_optional:
    ...
    def testPluginErrorOneOf5(self):
        """Test PluginErrorOneOf5"""
