...
class TestDatevImportResponse(unittest.TestCase):
    """DatevImportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatevImportResponse:
        """Test DatevImportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatevImportResponse`
        """
        model = DatevImportResponse()
        if include_optional:
            return DatevImportResponse(
                count = 0,
                filename = '',
                rows = [
                    simplebilly_api.models.datev_import_row.DatevImportRow(
                        account = '', 
                        amount = '', 
                        base_amount = '', 
                        base_currency = '', 
    ...
    def testDatevImportResponse(self):
        """Test DatevImportResponse"""
