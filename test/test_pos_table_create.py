...
class TestPosTableCreate(unittest.TestCase):
    """PosTableCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PosTableCreate:
        """Test PosTableCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PosTableCreate`
        """
        model = PosTableCreate()
        if include_optional:
            return PosTableCreate(
