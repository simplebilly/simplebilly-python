...
class TestGewinnverwendungsZeile(unittest.TestCase):
    """GewinnverwendungsZeile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GewinnverwendungsZeile:
        """Test GewinnverwendungsZeile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GewinnverwendungsZeile`
        """
        model = GewinnverwendungsZeile()
        if include_optional:
            return GewinnverwendungsZeile(
                betrag = '',
                label = ''
            )
        else:
    ...
    def testGewinnverwendungsZeile(self):
        """Test GewinnverwendungsZeile"""
