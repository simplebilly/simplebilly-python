...
class TestReplenishmentSuggestionLine(unittest.TestCase):
    """ReplenishmentSuggestionLine unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplenishmentSuggestionLine:
        ...
        """
        model = ReplenishmentSuggestionLine()
        if include_optional:
    ...
    def testReplenishmentSuggestionLine(self):
        """Test ReplenishmentSuggestionLine"""
