...
class TestYearTotal(unittest.TestCase):
    """YearTotal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YearTotal:
        """Test YearTotal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YearTotal`
        """
        model = YearTotal()
        if include_optional:
            return YearTotal(
