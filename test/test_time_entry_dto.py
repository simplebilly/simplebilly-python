...
class TestTimeEntryDto(unittest.TestCase):
    """TimeEntryDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeEntryDto:
        """Test TimeEntryDto
        ...
        if include_optional:
            return TimeEntryDto(
                clock_in = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                clock_out = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
