...
class TestReturnOrderStatusUpdate(unittest.TestCase):
    """ReturnOrderStatusUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnOrderStatusUpdate:
        """Test ReturnOrderStatusUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnOrderStatusUpdate`
        """
        model = ReturnOrderStatusUpdate()
        if include_optional:
            return ReturnOrderStatusUpdate(
                status = ''
            )
        else:
            return ReturnOrderStatusUpdate(
    ...
    def testReturnOrderStatusUpdate(self):
        """Test ReturnOrderStatusUpdate"""
