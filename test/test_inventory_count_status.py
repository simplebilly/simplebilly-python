...
class TestInventoryCountStatus(unittest.TestCase):
    """InventoryCountStatus unit test stubs"""
    ...
    def testInventoryCountStatus(self):
        """Test InventoryCountStatus"""
        # inst = InventoryCountStatus()
