...
class TestGewerbesteuerErgebnis(unittest.TestCase):
    """GewerbesteuerErgebnis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GewerbesteuerErgebnis:
    ...
    def testGewerbesteuerErgebnis(self):
        """Test GewerbesteuerErgebnis"""
