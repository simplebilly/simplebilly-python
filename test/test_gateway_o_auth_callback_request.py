...
class TestGatewayOAuthCallbackRequest(unittest.TestCase):
    """GatewayOAuthCallbackRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GatewayOAuthCallbackRequest:
        """Test GatewayOAuthCallbackRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GatewayOAuthCallbackRequest`
        """
        model = GatewayOAuthCallbackRequest()
        if include_optional:
    ...
    def testGatewayOAuthCallbackRequest(self):
        """Test GatewayOAuthCallbackRequest"""
