...
class TestApiResponseUserProfileData(unittest.TestCase):
    """ApiResponseUserProfileData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseUserProfileData:
        """Test ApiResponseUserProfileData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseUserProfileData`
        """
        model = ApiResponseUserProfileData()
        if include_optional:
    ...
    def testApiResponseUserProfileData(self):
        """Test ApiResponseUserProfileData"""
