...
class TestDunningResult(unittest.TestCase):
    """DunningResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DunningResult:
        """Test DunningResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DunningResult`
        """
        model = DunningResult()
        if include_optional:
