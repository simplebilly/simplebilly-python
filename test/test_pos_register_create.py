...
class TestPosRegisterCreate(unittest.TestCase):
    """PosRegisterCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PosRegisterCreate:
        """Test PosRegisterCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PosRegisterCreate`
        """
        model = PosRegisterCreate()
        if include_optional:
            return PosRegisterCreate(
                name = '0',
                status = 'active'
            )
        else:
    ...
    def testPosRegisterCreate(self):
        """Test PosRegisterCreate"""
