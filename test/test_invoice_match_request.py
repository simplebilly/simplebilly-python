...
class TestInvoiceMatchRequest(unittest.TestCase):
    """InvoiceMatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoiceMatchRequest:
        """Test InvoiceMatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceMatchRequest`
        """
        model = InvoiceMatchRequest()
        if include_optional:
    ...
    def testInvoiceMatchRequest(self):
        """Test InvoiceMatchRequest"""
