...
class TestTrackOrderResponse(unittest.TestCase):
    """TrackOrderResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrackOrderResponse:
        """Test TrackOrderResponse
        ...
        if include_optional:
            return TrackOrderResponse(
                ...
                order_status = '',
                shipments = [
                    simplebilly_api.models.tracked_shipment.TrackedShipment(
                        carrier = '', 
                        events = [
                            simplebilly_api.models.tracking_event.TrackingEvent(
                                date = '', 
                                description = '', 
                                location = '', 
                                status = '', )
    ...
    def testTrackOrderResponse(self):
        """Test TrackOrderResponse"""
