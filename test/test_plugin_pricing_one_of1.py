...
class TestPluginPricingOneOf1(unittest.TestCase):
    """PluginPricingOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PluginPricingOneOf1:
        """Test PluginPricingOneOf1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginPricingOneOf1`
        """
        model = PluginPricingOneOf1()
        if include_optional:
    ...
    def testPluginPricingOneOf1(self):
        """Test PluginPricingOneOf1"""
