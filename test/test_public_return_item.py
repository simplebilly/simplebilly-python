...
class TestPublicReturnItem(unittest.TestCase):
    """PublicReturnItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicReturnItem:
        """Test PublicReturnItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicReturnItem`
        """
        model = PublicReturnItem()
        if include_optional:
