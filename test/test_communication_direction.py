...
class TestCommunicationDirection(unittest.TestCase):
    """CommunicationDirection unit test stubs"""
    ...
    def testCommunicationDirection(self):
        """Test CommunicationDirection"""
        # inst = CommunicationDirection()
