...
class TestImportTestResponse(unittest.TestCase):
    """ImportTestResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportTestResponse:
        """Test ImportTestResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportTestResponse`
        """
        model = ImportTestResponse()
        if include_optional:
    ...
    def testImportTestResponse(self):
        """Test ImportTestResponse"""
