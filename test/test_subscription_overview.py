...
class TestSubscriptionOverview(unittest.TestCase):
    """SubscriptionOverview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionOverview:
    ...
    def testSubscriptionOverview(self):
        """Test SubscriptionOverview"""
