...
class TestCreateSepaDirectDebitApi(unittest.TestCase):
    """CreateSepaDirectDebitApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CreateSepaDirectDebitApi()

    def tearDown(self) -> None:
        pass

    def test_create_sepa_direct_debit_api(self) -> None:
        """Test case for create_sepa_direct_debit_api
