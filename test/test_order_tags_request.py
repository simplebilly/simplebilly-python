...
class TestOrderTagsRequest(unittest.TestCase):
    """OrderTagsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderTagsRequest:
        """Test OrderTagsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderTagsRequest`
        """
        model = OrderTagsRequest()
        if include_optional:
            return OrderTagsRequest(
                tags = [
                    ''
                    ]
            )
