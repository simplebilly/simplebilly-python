...
class TestProductionOrderStatusUpdate(unittest.TestCase):
    """ProductionOrderStatusUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductionOrderStatusUpdate:
        """Test ProductionOrderStatusUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductionOrderStatusUpdate`
        """
        model = ProductionOrderStatusUpdate()
        if include_optional:
            return ProductionOrderStatusUpdate(
                status = ''
            )
        else:
            return ProductionOrderStatusUpdate(
    ...
    def testProductionOrderStatusUpdate(self):
        """Test ProductionOrderStatusUpdate"""
