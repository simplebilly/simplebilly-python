...
class TestStilleReport(unittest.TestCase):
    """StilleReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StilleReport:
        """Test StilleReport
        ...
        if include_optional:
            return StilleReport(
                jahresueberschuss = '',
                partners = [
                    simplebilly_api.models.stille_partner_zeile.StillePartnerZeile(
