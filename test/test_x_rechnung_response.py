...
class TestXRechnungResponse(unittest.TestCase):
    """XRechnungResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XRechnungResponse:
        """Test XRechnungResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XRechnungResponse`
        """
        model = XRechnungResponse()
        if include_optional:
    ...
    def testXRechnungResponse(self):
        """Test XRechnungResponse"""
