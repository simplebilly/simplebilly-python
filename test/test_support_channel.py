...
class TestSupportChannel(unittest.TestCase):
    """SupportChannel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupportChannel:
        """Test SupportChannel
