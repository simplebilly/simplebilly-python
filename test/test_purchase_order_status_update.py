...
class TestPurchaseOrderStatusUpdate(unittest.TestCase):
    """PurchaseOrderStatusUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PurchaseOrderStatusUpdate:
        """Test PurchaseOrderStatusUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PurchaseOrderStatusUpdate`
        """
        model = PurchaseOrderStatusUpdate()
        if include_optional:
            return PurchaseOrderStatusUpdate(
                status = ''
            )
        else:
            return PurchaseOrderStatusUpdate(
    ...
    def testPurchaseOrderStatusUpdate(self):
        """Test PurchaseOrderStatusUpdate"""
