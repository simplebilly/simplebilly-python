...
class TestDeliveryAppointmentStatus(unittest.TestCase):
    """DeliveryAppointmentStatus unit test stubs"""
    ...
    def testDeliveryAppointmentStatus(self):
        """Test DeliveryAppointmentStatus"""
        # inst = DeliveryAppointmentStatus()
