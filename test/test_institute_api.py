...
class TestInstituteApi(unittest.TestCase):
    """InstituteApi unit test stubs"""

    def setUp(self) -> None:
        self.api = InstituteApi()

    def tearDown(self) -> None:
        pass

    def test_institute_status_api(self) -> None:
        """Test case for institute_status_api
