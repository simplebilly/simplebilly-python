...
class TestGezReport(unittest.TestCase):
    """GezReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GezReport:
        """Test GezReport
        ...
        if include_optional:
            return GezReport(
                beitragsfreie_kfz = 0,
                beitragspflichtige_kfz = 0,
                betriebsstaetten = [
                    simplebilly_api.models.betriebsstaetten_detail.BetriebsstaettenDetail(
                        beschaefigte = 0, 
                        monatlicher_beitrag = '', 
                        name = '', )
                    ],
