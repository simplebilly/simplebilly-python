...
class TestVerfahrensdokumentation(unittest.TestCase):
    """Verfahrensdokumentation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Verfahrensdokumentation:
        """Test Verfahrensdokumentation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Verfahrensdokumentation`
        """
        model = Verfahrensdokumentation()
        if include_optional:
            return Verfahrensdokumentation(
                entries = [
                    simplebilly_api.models.compliance_entry.ComplianceEntry(
                        description = '', 
                        module = '', 
                        regulations = [
                            ''
    ...
    def testVerfahrensdokumentation(self):
        """Test Verfahrensdokumentation"""
