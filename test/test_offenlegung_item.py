...
class TestOffenlegungItem(unittest.TestCase):
    """OffenlegungItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OffenlegungItem:
        """Test OffenlegungItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OffenlegungItem`
        """
        model = OffenlegungItem()
        if include_optional:
