...
class TestDownPaymentInvoice(unittest.TestCase):
    """DownPaymentInvoice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DownPaymentInvoice:
    ...
    def testDownPaymentInvoice(self):
        """Test DownPaymentInvoice"""
