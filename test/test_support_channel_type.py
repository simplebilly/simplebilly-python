...
class TestSupportChannelType(unittest.TestCase):
    """SupportChannelType unit test stubs"""
    ...
    def testSupportChannelType(self):
        """Test SupportChannelType"""
        # inst = SupportChannelType()
