...
class TestKonzernExportResponse(unittest.TestCase):
    """KonzernExportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KonzernExportResponse:
        """Test KonzernExportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KonzernExportResponse`
        """
        model = KonzernExportResponse()
        if include_optional:
    ...
    def testKonzernExportResponse(self):
        """Test KonzernExportResponse"""
