...
class TestGroupFigureUpdate(unittest.TestCase):
    """GroupFigureUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupFigureUpdate:
        """Test GroupFigureUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupFigureUpdate`
        """
        model = GroupFigureUpdate()
        if include_optional:
            return GroupFigureUpdate(
                bilanzsumme = '',
    ...
    def testGroupFigureUpdate(self):
        """Test GroupFigureUpdate"""
