...
class TestBudgetKategorie(unittest.TestCase):
    """BudgetKategorie unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BudgetKategorie:
        """Test BudgetKategorie
