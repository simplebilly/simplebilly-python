...
class TestBilanzItem(unittest.TestCase):
    """BilanzItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BilanzItem:
        """Test BilanzItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BilanzItem`
        """
        model = BilanzItem()
        if include_optional:
            return BilanzItem(
