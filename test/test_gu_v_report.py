...
class TestGuVReport(unittest.TestCase):
    """GuVReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuVReport:
        """Test GuVReport
        ...
        if include_optional:
            return GuVReport(
                expenses = [
                    simplebilly_api.models.gu_v_item.GuVItem(
                        account = '', 
                        amount = '', 
                        name = '', )
                    ],
