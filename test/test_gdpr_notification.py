...
class TestGdprNotification(unittest.TestCase):
    """GdprNotification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GdprNotification:
        """Test GdprNotification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GdprNotification`
        """
        model = GdprNotification()
        if include_optional:
