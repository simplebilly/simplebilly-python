    ...
    def make_instance(self, include_optional) -> AuthResponse:
        ...
        if include_optional:
            return AuthResponse(
                ...
                refresh_token = '',
                success = True,
                user = simplebilly_api.models.model.Model(
                    backup_codes = [
                        ''
                        ], 
                    ...
                    oauth_id = '', 
                    oauth_provider = '', 
                    password_changed_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    password_hash = '', 
                    picture = '', 
                    privacy_accepted_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    totp_secret = '', 
