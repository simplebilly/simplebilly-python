...
class TestEmissionsExportResponse(unittest.TestCase):
    """EmissionsExportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmissionsExportResponse:
        """Test EmissionsExportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmissionsExportResponse`
        """
        model = EmissionsExportResponse()
        if include_optional:
    ...
    def testEmissionsExportResponse(self):
        """Test EmissionsExportResponse"""
