...
class TestBudgetErgebnis(unittest.TestCase):
    """BudgetErgebnis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BudgetErgebnis:
        """Test BudgetErgebnis
        ...
        """
        model = BudgetErgebnis()
        if include_optional:
            return BudgetErgebnis(
                jahr = 56,
                monat = 0,
                monats_budget = [
                    simplebilly_api.models.budget_kategorie.BudgetKategorie(
                        budget = '', 
                        differenz = '', 
                        goal = '', 
                        ist = '', 
