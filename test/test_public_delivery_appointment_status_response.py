...
class TestPublicDeliveryAppointmentStatusResponse(unittest.TestCase):
    """PublicDeliveryAppointmentStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicDeliveryAppointmentStatusResponse:
        ...
        """
        model = PublicDeliveryAppointmentStatusResponse()
        if include_optional:
    ...
    def testPublicDeliveryAppointmentStatusResponse(self):
        """Test PublicDeliveryAppointmentStatusResponse"""
