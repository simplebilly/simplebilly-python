...
class TestSalesVolumeItem(unittest.TestCase):
    """SalesVolumeItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesVolumeItem:
        """Test SalesVolumeItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesVolumeItem`
        """
        model = SalesVolumeItem()
        if include_optional:
