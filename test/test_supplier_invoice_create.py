...
class TestSupplierInvoiceCreate(unittest.TestCase):
    """SupplierInvoiceCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupplierInvoiceCreate:
        """Test SupplierInvoiceCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupplierInvoiceCreate`
        """
        model = SupplierInvoiceCreate()
        if include_optional:
    ...
    def testSupplierInvoiceCreate(self):
        """Test SupplierInvoiceCreate"""
