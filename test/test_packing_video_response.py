...
class TestPackingVideoResponse(unittest.TestCase):
    """PackingVideoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PackingVideoResponse:
        """Test PackingVideoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PackingVideoResponse`
        """
        model = PackingVideoResponse()
        if include_optional:
    ...
    def testPackingVideoResponse(self):
        """Test PackingVideoResponse"""
