...
class TestKonzernBeteiligung(unittest.TestCase):
    """KonzernBeteiligung unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KonzernBeteiligung:
        """Test KonzernBeteiligung
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KonzernBeteiligung`
        """
        model = KonzernBeteiligung()
        if include_optional:
    ...
    def testKonzernBeteiligung(self):
        """Test KonzernBeteiligung"""
