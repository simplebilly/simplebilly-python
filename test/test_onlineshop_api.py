...
class TestOnlineshopApi(unittest.TestCase):
    """OnlineshopApi unit test stubs"""

    def setUp(self) -> None:
        self.api = OnlineshopApi()

    def tearDown(self) -> None:
        pass

    def test_get_smtp_config_api(self) -> None:
        """Test case for get_smtp_config_api

        """
        pass

    def test_save_smtp_config_api(self) -> None:
        """Test case for save_smtp_config_api
