...
class TestComplianceEntry(unittest.TestCase):
    """ComplianceEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComplianceEntry:
        """Test ComplianceEntry
