...
class TestPostingCategory(unittest.TestCase):
    """PostingCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostingCategory:
        """Test PostingCategory
