...
class TestSuitabilityApi(unittest.TestCase):
    """SuitabilityApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SuitabilityApi()

    def tearDown(self) -> None:
        pass

    def test_shipping_suitability_api(self) -> None:
        """Test case for shipping_suitability_api
