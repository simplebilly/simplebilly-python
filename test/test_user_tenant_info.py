...
class TestUserTenantInfo(unittest.TestCase):
    """UserTenantInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserTenantInfo:
        """Test UserTenantInfo
