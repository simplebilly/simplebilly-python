...
class TestUpdateAutomation(unittest.TestCase):
    """UpdateAutomation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAutomation:
