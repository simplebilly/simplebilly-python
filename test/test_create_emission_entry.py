...
class TestCreateEmissionEntry(unittest.TestCase):
    """CreateEmissionEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateEmissionEntry:
        """Test CreateEmissionEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateEmissionEntry`
        """
        model = CreateEmissionEntry()
        if include_optional:
    ...
    def testCreateEmissionEntry(self):
        """Test CreateEmissionEntry"""
