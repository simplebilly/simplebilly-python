...
class TestOssReport(unittest.TestCase):
    """OssReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OssReport:
        """Test OssReport
        ...
        if include_optional:
            return OssReport(
                dependencies = [
                    simplebilly_api.models.oss_dependency.OssDependency(
                        dependency_type = '', 
                        license = '', 
                        name = '', 
                        version = '', )
