...
class TestSepaDirectDebitResponse(unittest.TestCase):
    """SepaDirectDebitResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SepaDirectDebitResponse:
        """Test SepaDirectDebitResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SepaDirectDebitResponse`
        """
        model = SepaDirectDebitResponse()
        if include_optional:
    ...
    def testSepaDirectDebitResponse(self):
        """Test SepaDirectDebitResponse"""
