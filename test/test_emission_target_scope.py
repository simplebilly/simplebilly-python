...
class TestEmissionTargetScope(unittest.TestCase):
    """EmissionTargetScope unit test stubs"""
    ...
    def testEmissionTargetScope(self):
        """Test EmissionTargetScope"""
        # inst = EmissionTargetScope()
