...
class TestDhlCredentials(unittest.TestCase):
    """DhlCredentials unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DhlCredentials:
        """Test DhlCredentials
        ...
        """
        model = DhlCredentials()
        if include_optional:
            return DhlCredentials(
                api_key = '',
                client_id = '',
                client_secret = ''
            )
