...
class TestPayGapExportResponse(unittest.TestCase):
    """PayGapExportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayGapExportResponse:
        """Test PayGapExportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayGapExportResponse`
        """
        model = PayGapExportResponse()
        if include_optional:
    ...
    def testPayGapExportResponse(self):
        """Test PayGapExportResponse"""
