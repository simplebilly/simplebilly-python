...
class TestConfigFieldInfo(unittest.TestCase):
    """ConfigFieldInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigFieldInfo:
