...
class TestLegalDocumentReset(unittest.TestCase):
    """LegalDocumentReset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegalDocumentReset:
        """Test LegalDocumentReset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LegalDocumentReset`
        """
        model = LegalDocumentReset()
        if include_optional:
            return LegalDocumentReset(
                doc_type = '',
                lang = ''
            )
        else:
    ...
    def testLegalDocumentReset(self):
        """Test LegalDocumentReset"""
