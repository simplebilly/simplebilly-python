...
class TestServiceAssignment(unittest.TestCase):
    """ServiceAssignment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceAssignment:
        """Test ServiceAssignment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceAssignment`
        """
    ...
    def testServiceAssignment(self):
        """Test ServiceAssignment"""
