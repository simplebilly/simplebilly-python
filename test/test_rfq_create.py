...
class TestRfqCreate(unittest.TestCase):
    """RfqCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RfqCreate:
        """Test RfqCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RfqCreate`
        """
        model = RfqCreate()
        if include_optional:
            return RfqCreate(
                ...
                response_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                rfq_number = '',
                status = 'draft',
                supplier_contact_id = '',
                supplier_name = ''
