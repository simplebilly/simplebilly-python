...
class TestRecurringTemplateUpdate(unittest.TestCase):
    """RecurringTemplateUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecurringTemplateUpdate:
        """Test RecurringTemplateUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecurringTemplateUpdate`
        """
        model = RecurringTemplateUpdate()
        if include_optional:
            return RecurringTemplateUpdate(
    ...
    def testRecurringTemplateUpdate(self):
        """Test RecurringTemplateUpdate"""
