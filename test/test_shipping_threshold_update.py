...
class TestShippingThresholdUpdate(unittest.TestCase):
    """ShippingThresholdUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingThresholdUpdate:
        """Test ShippingThresholdUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingThresholdUpdate`
        """
        model = ShippingThresholdUpdate()
        if include_optional:
    ...
    def testShippingThresholdUpdate(self):
        """Test ShippingThresholdUpdate"""
