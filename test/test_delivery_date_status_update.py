...
class TestDeliveryDateStatusUpdate(unittest.TestCase):
    """DeliveryDateStatusUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliveryDateStatusUpdate:
        """Test DeliveryDateStatusUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliveryDateStatusUpdate`
        """
        model = DeliveryDateStatusUpdate()
        if include_optional:
            return DeliveryDateStatusUpdate(
                status = ''
            )
        else:
            return DeliveryDateStatusUpdate(
    ...
    def testDeliveryDateStatusUpdate(self):
        """Test DeliveryDateStatusUpdate"""
