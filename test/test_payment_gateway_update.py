...
class TestPaymentGatewayUpdate(unittest.TestCase):
    """PaymentGatewayUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentGatewayUpdate:
        """Test PaymentGatewayUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentGatewayUpdate`
        """
        model = PaymentGatewayUpdate()
        if include_optional:
    ...
    def testPaymentGatewayUpdate(self):
        """Test PaymentGatewayUpdate"""
