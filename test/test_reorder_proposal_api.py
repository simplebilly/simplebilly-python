...
class TestReorderProposalApi(unittest.TestCase):
    """ReorderProposalApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ReorderProposalApi()

    def tearDown(self) -> None:
        pass

    def test_apply_reorder_proposal(self) -> None:
        """Test case for apply_reorder_proposal

        Convert a reorder proposal into a draft purchase order.
        """
        pass

    def test_get_reorder_proposal(self) -> None:
        """Test case for get_reorder_proposal
