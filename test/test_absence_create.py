...
class TestAbsenceCreate(unittest.TestCase):
    """AbsenceCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AbsenceCreate:
        """Test AbsenceCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AbsenceCreate`
        """
        model = AbsenceCreate()
        if include_optional:
