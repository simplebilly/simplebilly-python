...
class TestGewinnverwendungApi(unittest.TestCase):
    """GewinnverwendungApi unit test stubs"""

    def setUp(self) -> None:
        self.api = GewinnverwendungApi()

    def tearDown(self) -> None:
        pass

    def test_gewinnverwendung_api(self) -> None:
        """Test case for gewinnverwendung_api

        """
        pass

    def test_gewinnverwendung_export_api(self) -> None:
        """Test case for gewinnverwendung_export_api
