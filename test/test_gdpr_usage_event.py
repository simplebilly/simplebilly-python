...
class TestGdprUsageEvent(unittest.TestCase):
    """GdprUsageEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GdprUsageEvent:
        """Test GdprUsageEvent
