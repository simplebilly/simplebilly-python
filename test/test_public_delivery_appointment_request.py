...
class TestPublicDeliveryAppointmentRequest(unittest.TestCase):
    """PublicDeliveryAppointmentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicDeliveryAppointmentRequest:
        """Test PublicDeliveryAppointmentRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicDeliveryAppointmentRequest`
        """
        model = PublicDeliveryAppointmentRequest()
        if include_optional:
            return PublicDeliveryAppointmentRequest(
                email = '',
                notes = '',
                requested_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                supplier_name = '',
                time_slot = '',
                warehouse_code = ''
            )
    ...
    def testPublicDeliveryAppointmentRequest(self):
        """Test PublicDeliveryAppointmentRequest"""
