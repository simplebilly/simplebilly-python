...
class TestInventoryValueApi(unittest.TestCase):
    """InventoryValueApi unit test stubs"""

    def setUp(self) -> None:
        self.api = InventoryValueApi()

    def tearDown(self) -> None:
        pass

    def test_get_inventory_value_api(self) -> None:
        """Test case for get_inventory_value_api

        """
        pass

    def test_record_inventory_value_api(self) -> None:
        """Test case for record_inventory_value_api
