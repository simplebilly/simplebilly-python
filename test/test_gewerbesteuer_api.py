...
class TestGewerbesteuerApi(unittest.TestCase):
    """GewerbesteuerApi unit test stubs"""

    def setUp(self) -> None:
        self.api = GewerbesteuerApi()

    def tearDown(self) -> None:
        pass

    def test_gewerbesteuer_api(self) -> None:
        """Test case for gewerbesteuer_api
