...
class TestInventoryCountUpdate(unittest.TestCase):
    """InventoryCountUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryCountUpdate:
        """Test InventoryCountUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryCountUpdate`
        """
        model = InventoryCountUpdate()
        if include_optional:
            return InventoryCountUpdate(
                count_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                count_number = '',
                line_items = None,
                notes = '',
                status = 'draft',
    ...
    def testInventoryCountUpdate(self):
        """Test InventoryCountUpdate"""
