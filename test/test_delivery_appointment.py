...
class TestDeliveryAppointment(unittest.TestCase):
    """DeliveryAppointment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliveryAppointment:
        """Test DeliveryAppointment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliveryAppointment`
        """
    ...
    def testDeliveryAppointment(self):
        """Test DeliveryAppointment"""
