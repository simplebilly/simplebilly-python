...
class TestPaymentConditionApi(unittest.TestCase):
    """PaymentConditionApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PaymentConditionApi()

    def tearDown(self) -> None:
        pass

    def test_list_payment_conditions_api(self) -> None:
        """Test case for list_payment_conditions_api
