...
class TestImportStartRequest(unittest.TestCase):
    """ImportStartRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportStartRequest:
    ...
    def testImportStartRequest(self):
        """Test ImportStartRequest"""
