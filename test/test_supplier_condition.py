...
class TestSupplierCondition(unittest.TestCase):
    """SupplierCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupplierCondition:
        """Test SupplierCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupplierCondition`
        """
    ...
    def testSupplierCondition(self):
        """Test SupplierCondition"""
