...
class TestComplianceTraining(unittest.TestCase):
    """ComplianceTraining unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComplianceTraining:
    ...
    def testComplianceTraining(self):
        """Test ComplianceTraining"""
