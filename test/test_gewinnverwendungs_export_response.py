...
class TestGewinnverwendungsExportResponse(unittest.TestCase):
    """GewinnverwendungsExportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GewinnverwendungsExportResponse:
        """Test GewinnverwendungsExportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GewinnverwendungsExportResponse`
        """
        model = GewinnverwendungsExportResponse()
        if include_optional:
    ...
    def testGewinnverwendungsExportResponse(self):
        """Test GewinnverwendungsExportResponse"""
