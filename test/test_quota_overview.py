...
class TestQuotaOverview(unittest.TestCase):
    """QuotaOverview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuotaOverview:
        """Test QuotaOverview
        ...
        if include_optional:
            return QuotaOverview(
                ...
                metered = [
                    simplebilly_api.models.metered_usage.MeteredUsage(
                        limit = 56, 
                        meter = '', 
                        used = 56, )
                    ],
