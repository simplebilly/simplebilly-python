...
class TestPaymentGatewayCreate(unittest.TestCase):
    """PaymentGatewayCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentGatewayCreate:
        """Test PaymentGatewayCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentGatewayCreate`
        """
        model = PaymentGatewayCreate()
        if include_optional:
    ...
    def testPaymentGatewayCreate(self):
        """Test PaymentGatewayCreate"""
