...
class TestImportStartResponse(unittest.TestCase):
    """ImportStartResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportStartResponse:
        """Test ImportStartResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportStartResponse`
        """
        model = ImportStartResponse()
        if include_optional:
    ...
    def testImportStartResponse(self):
        """Test ImportStartResponse"""
