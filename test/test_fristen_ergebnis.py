...
class TestFristenErgebnis(unittest.TestCase):
    """FristenErgebnis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FristenErgebnis:
        """Test FristenErgebnis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FristenErgebnis`
        """
        model = FristenErgebnis()
        if include_optional:
            return FristenErgebnis(
                anzahl = 0,
                fristen = [
                    simplebilly_api.models.frist_eintrag.FristEintrag(
                        bezeichnung = '', 
                        faellig = '', 
                        faellig_original = '', 
                        hinweis = '', 
