...
class TestConfigFieldKindOneOf(unittest.TestCase):
    """ConfigFieldKindOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigFieldKindOneOf:
        """Test ConfigFieldKindOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigFieldKindOneOf`
        """
        model = ConfigFieldKindOneOf()
        if include_optional:
    ...
    def testConfigFieldKindOneOf(self):
        """Test ConfigFieldKindOneOf"""
