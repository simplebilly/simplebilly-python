...
class TestPublicDeliveryAppointmentResponse(unittest.TestCase):
    """PublicDeliveryAppointmentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicDeliveryAppointmentResponse:
        """Test PublicDeliveryAppointmentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicDeliveryAppointmentResponse`
        """
        model = PublicDeliveryAppointmentResponse()
        if include_optional:
    ...
    def testPublicDeliveryAppointmentResponse(self):
        """Test PublicDeliveryAppointmentResponse"""
