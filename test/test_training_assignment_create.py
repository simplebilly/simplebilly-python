...
class TestTrainingAssignmentCreate(unittest.TestCase):
    """TrainingAssignmentCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrainingAssignmentCreate:
        """Test TrainingAssignmentCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrainingAssignmentCreate`
        """
        model = TrainingAssignmentCreate()
        if include_optional:
            return TrainingAssignmentCreate(
                assigned_by = '',
    ...
    def testTrainingAssignmentCreate(self):
        """Test TrainingAssignmentCreate"""
