...
class TestContactHistoryResponse(unittest.TestCase):
    """ContactHistoryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactHistoryResponse:
        """Test ContactHistoryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactHistoryResponse`
        """
        model = ContactHistoryResponse()
        if include_optional:
            return ContactHistoryResponse(
                contact_id = '',
                inbound_count = 0,
                items = [
                    simplebilly_api.models.customer_communication.CustomerCommunication(
                        body = '', 
                        channel = 'email', 
                        contact_id = '', 
                        counterparty = '', 
    ...
    def testContactHistoryResponse(self):
        """Test ContactHistoryResponse"""
