...
class TestLeadUpdate(unittest.TestCase):
    """LeadUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeadUpdate:
        """Test LeadUpdate
        ...
        if include_optional:
            return LeadUpdate(
                ...
                email = '',
                first_contact_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                name = '',
                notes = '',
                phone = '',
                score = 56,
