...
class TestBalanceItem(unittest.TestCase):
    """BalanceItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalanceItem:
        """Test BalanceItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceItem`
        """
        model = BalanceItem()
        if include_optional:
            return BalanceItem(
