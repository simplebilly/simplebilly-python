...
class TestParticipationUpdate(unittest.TestCase):
    """ParticipationUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ParticipationUpdate:
        """Test ParticipationUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ParticipationUpdate`
        """
        model = ParticipationUpdate()
        if include_optional:
    ...
    def testParticipationUpdate(self):
        """Test ParticipationUpdate"""
