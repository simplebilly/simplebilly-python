...
class TestShippingRuleUpdate(unittest.TestCase):
    """ShippingRuleUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingRuleUpdate:
        """Test ShippingRuleUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingRuleUpdate`
        """
        model = ShippingRuleUpdate()
        if include_optional:
    ...
    def testShippingRuleUpdate(self):
        """Test ShippingRuleUpdate"""
