...
class TestSilentPartnerCreate(unittest.TestCase):
    """SilentPartnerCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SilentPartnerCreate:
        """Test SilentPartnerCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SilentPartnerCreate`
        """
        model = SilentPartnerCreate()
        if include_optional:
    ...
    def testSilentPartnerCreate(self):
        """Test SilentPartnerCreate"""
