...
class TestPublicReturnResponse(unittest.TestCase):
    """PublicReturnResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicReturnResponse:
        """Test PublicReturnResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicReturnResponse`
        """
        model = PublicReturnResponse()
        if include_optional:
    ...
    def testPublicReturnResponse(self):
        """Test PublicReturnResponse"""
