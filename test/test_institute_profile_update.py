...
class TestInstituteProfileUpdate(unittest.TestCase):
    """InstituteProfileUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstituteProfileUpdate:
        """Test InstituteProfileUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstituteProfileUpdate`
        """
        model = InstituteProfileUpdate()
        if include_optional:
    ...
    def testInstituteProfileUpdate(self):
        """Test InstituteProfileUpdate"""
