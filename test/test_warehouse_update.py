...
class TestWarehouseUpdate(unittest.TestCase):
    """WarehouseUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WarehouseUpdate:
        """Test WarehouseUpdate
