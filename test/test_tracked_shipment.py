...
class TestTrackedShipment(unittest.TestCase):
    """TrackedShipment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrackedShipment:
        """Test TrackedShipment
