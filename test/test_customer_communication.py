...
class TestCustomerCommunication(unittest.TestCase):
    """CustomerCommunication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerCommunication:
        """Test CustomerCommunication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerCommunication`
        """
    ...
    def testCustomerCommunication(self):
        """Test CustomerCommunication"""
