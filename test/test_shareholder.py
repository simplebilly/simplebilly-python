...
class TestShareholder(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Shareholder:
        """Test Shareholder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Shareholder`
        """
        model = Shareholder()
        if include_optional:
            return Shareholder(
