...
class TestEuerZeile(unittest.TestCase):
    """EuerZeile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EuerZeile:
        """Test EuerZeile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EuerZeile`
        """
        model = EuerZeile()
        if include_optional:
            return EuerZeile(
