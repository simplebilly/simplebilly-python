...
class TestActivityStatusUpdate(unittest.TestCase):
    """ActivityStatusUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityStatusUpdate:
        """Test ActivityStatusUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityStatusUpdate`
        """
        model = ActivityStatusUpdate()
        if include_optional:
            return ActivityStatusUpdate(
                status = ''
            )
        else:
            return ActivityStatusUpdate(
    ...
    def testActivityStatusUpdate(self):
        """Test ActivityStatusUpdate"""
