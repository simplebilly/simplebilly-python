...
class TestYearlyPayrollSummary(unittest.TestCase):
    """YearlyPayrollSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YearlyPayrollSummary:
        """Test YearlyPayrollSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YearlyPayrollSummary`
        """
        model = YearlyPayrollSummary()
        if include_optional:
            return YearlyPayrollSummary(
                avg_employee_count = 56,
                months = [
                    simplebilly_api.models.payroll_summary_item.PayrollSummaryItem(
                        employee_count = 56, 
                        month = '', 
                        status = 'draft', 
                        total_employer_cost = '', 
    ...
    def testYearlyPayrollSummary(self):
        """Test YearlyPayrollSummary"""
