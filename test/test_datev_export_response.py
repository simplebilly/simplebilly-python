...
class TestDatevExportResponse(unittest.TestCase):
    """DatevExportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatevExportResponse:
        """Test DatevExportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatevExportResponse`
        """
        model = DatevExportResponse()
        if include_optional:
    ...
    def testDatevExportResponse(self):
        """Test DatevExportResponse"""
