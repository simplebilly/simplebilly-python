...
class TestProductAttributeUpdate(unittest.TestCase):
    """ProductAttributeUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductAttributeUpdate:
        """Test ProductAttributeUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductAttributeUpdate`
        """
        model = ProductAttributeUpdate()
        if include_optional:
    ...
    def testProductAttributeUpdate(self):
        """Test ProductAttributeUpdate"""
