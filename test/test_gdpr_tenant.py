...
class TestGdprTenant(unittest.TestCase):
    """GdprTenant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GdprTenant:
        """Test GdprTenant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GdprTenant`
        """
        model = GdprTenant()
        if include_optional:
            return GdprTenant(
