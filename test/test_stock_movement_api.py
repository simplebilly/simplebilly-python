...
class TestStockMovementApi(unittest.TestCase):
    """StockMovementApi unit test stubs"""

    def setUp(self) -> None:
        self.api = StockMovementApi()

    def tearDown(self) -> None:
        pass

    def test_get_stock_movement(self) -> None:
        """Test case for get_stock_movement

        """
        pass

    def test_list_stock_movements(self) -> None:
        """Test case for list_stock_movements
