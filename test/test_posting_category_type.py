...
class TestPostingCategoryType(unittest.TestCase):
    """PostingCategoryType unit test stubs"""
    ...
    def testPostingCategoryType(self):
        """Test PostingCategoryType"""
        # inst = PostingCategoryType()
