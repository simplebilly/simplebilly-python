...
class TestServiceJobCreate(unittest.TestCase):
    """ServiceJobCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceJobCreate:
        ...
        """
        model = ServiceJobCreate()
        if include_optional:
            return ServiceJobCreate(
                address = '0',
                customer_email = '',
                customer_id = '',
                customer_name = '',
