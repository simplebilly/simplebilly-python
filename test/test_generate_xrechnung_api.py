...
class TestGenerateXrechnungApi(unittest.TestCase):
    """GenerateXrechnungApi unit test stubs"""

    def setUp(self) -> None:
        self.api = GenerateXrechnungApi()

    def tearDown(self) -> None:
        pass

    def test_generate_xrechnung_api(self) -> None:
        """Test case for generate_xrechnung_api
