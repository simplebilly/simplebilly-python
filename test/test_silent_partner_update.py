...
class TestSilentPartnerUpdate(unittest.TestCase):
    """SilentPartnerUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SilentPartnerUpdate:
        """Test SilentPartnerUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SilentPartnerUpdate`
        """
        model = SilentPartnerUpdate()
        if include_optional:
            return SilentPartnerUpdate(
                contract_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                einlage = '',
                gewinnquote_pct = '',
                gewinnvortrag = '',
                instrument_type = 'typisch',
                kest_pflichtig = True,
                name = '0',
                notes = '',
                verlust_verrechnungskonto = '',
                verlustbeteiligung = True
            )
        else:
            return SilentPartnerUpdate(
        )
    ...
    def testSilentPartnerUpdate(self):
        """Test SilentPartnerUpdate"""
