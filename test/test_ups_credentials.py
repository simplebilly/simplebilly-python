...
class TestUpsCredentials(unittest.TestCase):
    """UpsCredentials unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsCredentials:
        """Test UpsCredentials
