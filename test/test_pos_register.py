...
class TestPosRegister(unittest.TestCase):
    """PosRegister unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PosRegister:
        """Test PosRegister
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PosRegister`
        """
        model = PosRegister()
        if include_optional:
            return PosRegister(
