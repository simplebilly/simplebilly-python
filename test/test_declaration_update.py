...
class TestDeclarationUpdate(unittest.TestCase):
    """DeclarationUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeclarationUpdate:
        """Test DeclarationUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeclarationUpdate`
        """
        model = DeclarationUpdate()
        if include_optional:
    ...
    def testDeclarationUpdate(self):
        """Test DeclarationUpdate"""
