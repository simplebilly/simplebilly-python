...
class TestGroupFigureCreate(unittest.TestCase):
    """GroupFigureCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupFigureCreate:
        """Test GroupFigureCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupFigureCreate`
        """
        model = GroupFigureCreate()
        if include_optional:
            return GroupFigureCreate(
                bilanzsumme = '',
    ...
    def testGroupFigureCreate(self):
        """Test GroupFigureCreate"""
