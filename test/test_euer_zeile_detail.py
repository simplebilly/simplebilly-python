...
class TestEuerZeileDetail(unittest.TestCase):
    """EuerZeileDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EuerZeileDetail:
        """Test EuerZeileDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EuerZeileDetail`
        """
        model = EuerZeileDetail()
        if include_optional:
