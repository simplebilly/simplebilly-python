...
class TestEbilanzApi(unittest.TestCase):
    """EbilanzApi unit test stubs"""
    ...
    def test_ebilanz_report_api(self) -> None:
        """Test case for ebilanz_report_api

        """
        pass

    def test_ebilanz_xbrl_export_api(self) -> None:
        """Test case for ebilanz_xbrl_export_api
