...
class TestCustomerGroupCreate(unittest.TestCase):
    """CustomerGroupCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerGroupCreate:
        """Test CustomerGroupCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerGroupCreate`
        """
        model = CustomerGroupCreate()
        if include_optional:
    ...
    def testCustomerGroupCreate(self):
        """Test CustomerGroupCreate"""
