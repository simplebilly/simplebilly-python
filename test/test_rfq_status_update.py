...
class TestRfqStatusUpdate(unittest.TestCase):
    """RfqStatusUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RfqStatusUpdate:
        """Test RfqStatusUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RfqStatusUpdate`
        """
        model = RfqStatusUpdate()
        if include_optional:
            return RfqStatusUpdate(
                status = ''
            )
        else:
            return RfqStatusUpdate(
