...
class TestPayrollSummaryItem(unittest.TestCase):
    """PayrollSummaryItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayrollSummaryItem:
        """Test PayrollSummaryItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayrollSummaryItem`
        """
        model = PayrollSummaryItem()
        if include_optional:
    ...
    def testPayrollSummaryItem(self):
        """Test PayrollSummaryItem"""
