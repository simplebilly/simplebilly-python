...
class TestInventoryCountCreate(unittest.TestCase):
    """InventoryCountCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryCountCreate:
        """Test InventoryCountCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryCountCreate`
        """
        model = InventoryCountCreate()
        if include_optional:
    ...
    def testInventoryCountCreate(self):
        """Test InventoryCountCreate"""
