...
class TestSubmitResultResponse(unittest.TestCase):
    """SubmitResultResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmitResultResponse:
    ...
    def testSubmitResultResponse(self):
        """Test SubmitResultResponse"""
