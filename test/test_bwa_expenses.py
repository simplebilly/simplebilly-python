...
class TestBWAExpenses(unittest.TestCase):
    """BWAExpenses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BWAExpenses:
        """Test BWAExpenses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BWAExpenses`
        """
        model = BWAExpenses()
        if include_optional:
            return BWAExpenses(
