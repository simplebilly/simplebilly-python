...
class TestStockTransferStatusUpdate(unittest.TestCase):
    """StockTransferStatusUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StockTransferStatusUpdate:
        """Test StockTransferStatusUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StockTransferStatusUpdate`
        """
        model = StockTransferStatusUpdate()
        if include_optional:
            return StockTransferStatusUpdate(
                status = ''
            )
        else:
            return StockTransferStatusUpdate(
    ...
    def testStockTransferStatusUpdate(self):
        """Test StockTransferStatusUpdate"""
