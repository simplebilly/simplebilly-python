...
class TestEmissionTarget(unittest.TestCase):
    """EmissionTarget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmissionTarget:
        """Test EmissionTarget
