...
class TestKostenVorschau(unittest.TestCase):
    """KostenVorschau unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KostenVorschau:
        """Test KostenVorschau
        ...
        """
        model = KostenVorschau()
        if include_optional:
            return KostenVorschau(
                eintraege = [
                    simplebilly_api.models.kosten_eintrag.KostenEintrag(
                        beschreibung = '', 
                        betrag = '', 
                        datum = '', 
                        typ = '', )
