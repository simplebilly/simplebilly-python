...
class TestReturnOrderStatus(unittest.TestCase):
    """ReturnOrderStatus unit test stubs"""
    ...
    def testReturnOrderStatus(self):
        """Test ReturnOrderStatus"""
        # inst = ReturnOrderStatus()
