...
class TestEmailTemplateStatus(unittest.TestCase):
    """EmailTemplateStatus unit test stubs"""
    ...
    def testEmailTemplateStatus(self):
        """Test EmailTemplateStatus"""
        # inst = EmailTemplateStatus()
