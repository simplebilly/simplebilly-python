...
class TestBilanzReport(unittest.TestCase):
    """BilanzReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BilanzReport:
        """Test BilanzReport
        ...
        if include_optional:
            return BilanzReport(
                aktiva = [
                    simplebilly_api.models.bilanz_item.BilanzItem(
                        amount = '', 
                        konto = '', 
                        name = '', )
                    ],
