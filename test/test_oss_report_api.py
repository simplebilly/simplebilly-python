...
class TestOssReportApi(unittest.TestCase):
    """OssReportApi unit test stubs"""

    def setUp(self) -> None:
        self.api = OssReportApi()

    def tearDown(self) -> None:
        pass

    def test_oss_report_api(self) -> None:
        """Test case for oss_report_api
