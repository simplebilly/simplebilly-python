...
class TestMarketplaceSyncLog(unittest.TestCase):
    """MarketplaceSyncLog unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketplaceSyncLog:
        """Test MarketplaceSyncLog
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketplaceSyncLog`
        """
    ...
    def testMarketplaceSyncLog(self):
        """Test MarketplaceSyncLog"""
