...
class TestInvoicePdfUrlResponse(unittest.TestCase):
    """InvoicePdfUrlResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoicePdfUrlResponse:
        """Test InvoicePdfUrlResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoicePdfUrlResponse`
        """
        model = InvoicePdfUrlResponse()
        if include_optional:
    ...
    def testInvoicePdfUrlResponse(self):
        """Test InvoicePdfUrlResponse"""
