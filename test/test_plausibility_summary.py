...
class TestPlausibilitySummary(unittest.TestCase):
    """PlausibilitySummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlausibilitySummary:
        """Test PlausibilitySummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlausibilitySummary`
        """
        model = PlausibilitySummary()
        if include_optional:
    ...
    def testPlausibilitySummary(self):
        """Test PlausibilitySummary"""
