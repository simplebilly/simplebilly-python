...
class TestInventoryValuePoint(unittest.TestCase):
    """InventoryValuePoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryValuePoint:
        """Test InventoryValuePoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryValuePoint`
        """
        model = InventoryValuePoint()
        if include_optional:
    ...
    def testInventoryValuePoint(self):
        """Test InventoryValuePoint"""
