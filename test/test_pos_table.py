...
class TestPosTable(unittest.TestCase):
    """PosTable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PosTable:
        """Test PosTable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PosTable`
        """
        model = PosTable()
        if include_optional:
            return PosTable(
