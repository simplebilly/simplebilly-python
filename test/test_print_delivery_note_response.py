...
class TestPrintDeliveryNoteResponse(unittest.TestCase):
    """PrintDeliveryNoteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrintDeliveryNoteResponse:
        """Test PrintDeliveryNoteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintDeliveryNoteResponse`
        """
        model = PrintDeliveryNoteResponse()
        if include_optional:
    ...
    def testPrintDeliveryNoteResponse(self):
        """Test PrintDeliveryNoteResponse"""
