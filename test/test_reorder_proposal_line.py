...
class TestReorderProposalLine(unittest.TestCase):
    """ReorderProposalLine unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReorderProposalLine:
        """Test ReorderProposalLine
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReorderProposalLine`
        """
        model = ReorderProposalLine()
        if include_optional:
    ...
    def testReorderProposalLine(self):
        """Test ReorderProposalLine"""
