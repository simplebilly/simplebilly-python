...
class TestCustomerCommunicationCreate(unittest.TestCase):
    """CustomerCommunicationCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerCommunicationCreate:
        """Test CustomerCommunicationCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerCommunicationCreate`
        """
        model = CustomerCommunicationCreate()
        if include_optional:
    ...
    def testCustomerCommunicationCreate(self):
        """Test CustomerCommunicationCreate"""
