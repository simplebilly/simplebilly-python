...
class TestOrderConfirmationCreate(unittest.TestCase):
    """OrderConfirmationCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderConfirmationCreate:
        """Test OrderConfirmationCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderConfirmationCreate`
        """
        model = OrderConfirmationCreate()
        if include_optional:
    ...
    def testOrderConfirmationCreate(self):
        """Test OrderConfirmationCreate"""
