...
class TestDeliveryNoteCreate(unittest.TestCase):
    """DeliveryNoteCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliveryNoteCreate:
        """Test DeliveryNoteCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliveryNoteCreate`
        """
        model = DeliveryNoteCreate()
        if include_optional:
    ...
    def testDeliveryNoteCreate(self):
        """Test DeliveryNoteCreate"""
