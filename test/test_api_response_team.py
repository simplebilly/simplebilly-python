...
class TestApiResponseTeam(unittest.TestCase):
    """ApiResponseTeam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseTeam:
        """Test ApiResponseTeam
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseTeam`
        """
        model = ApiResponseTeam()
        if include_optional:
            return ApiResponseTeam(
                data = simplebilly_api.models.api_response_team_data.ApiResponse_Team_data(
