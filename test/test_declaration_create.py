...
class TestDeclarationCreate(unittest.TestCase):
    """DeclarationCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeclarationCreate:
        """Test DeclarationCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeclarationCreate`
        """
        model = DeclarationCreate()
        if include_optional:
    ...
    def testDeclarationCreate(self):
        """Test DeclarationCreate"""
