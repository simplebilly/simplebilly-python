...
class TestPluginErrorOneOf6(unittest.TestCase):
    """PluginErrorOneOf6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PluginErrorOneOf6:
        """Test PluginErrorOneOf6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginErrorOneOf6`
        """
        model = PluginErrorOneOf6()
        if include_optional:
    ...
    def testPluginErrorOneOf6(self):
        """Test PluginErrorOneOf6"""
