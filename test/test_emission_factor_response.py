...
class TestEmissionFactorResponse(unittest.TestCase):
    """EmissionFactorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmissionFactorResponse:
        """Test EmissionFactorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmissionFactorResponse`
        """
        model = EmissionFactorResponse()
        if include_optional:
            return EmissionFactorResponse(
                category_id = '',
                kg_co2e_per_unit = 1.337,
                name_de = '',
                source = '',
                unit = '',
                version = ''
    ...
    def testEmissionFactorResponse(self):
        """Test EmissionFactorResponse"""
