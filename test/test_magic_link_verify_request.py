...
class TestMagicLinkVerifyRequest(unittest.TestCase):
    """MagicLinkVerifyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MagicLinkVerifyRequest:
        """Test MagicLinkVerifyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MagicLinkVerifyRequest`
        """
    ...
    def testMagicLinkVerifyRequest(self):
        """Test MagicLinkVerifyRequest"""
