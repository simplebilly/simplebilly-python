...
class TestEksErgebnis(unittest.TestCase):
    """EksErgebnis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EksErgebnis:
        """Test EksErgebnis
        ...
        if include_optional:
            return EksErgebnis(
                gesamtergebnis = '',
                monate = [
                    simplebilly_api.models.eks_monats_wert.EksMonatsWert(
                        ausgaben = '', 
                        einnahmen = '', 
                        ergebnis = '', 
                        monat = '', )
