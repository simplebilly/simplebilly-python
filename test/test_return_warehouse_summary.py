...
class TestReturnWarehouseSummary(unittest.TestCase):
    """ReturnWarehouseSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnWarehouseSummary:
        """Test ReturnWarehouseSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnWarehouseSummary`
        """
        model = ReturnWarehouseSummary()
        if include_optional:
    ...
    def testReturnWarehouseSummary(self):
        """Test ReturnWarehouseSummary"""
