...
class TestRecurringTemplateType(unittest.TestCase):
    """RecurringTemplateType unit test stubs"""
    ...
    def testRecurringTemplateType(self):
        """Test RecurringTemplateType"""
        # inst = RecurringTemplateType()
