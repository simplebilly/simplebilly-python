...
class TestPostingCategoryCreate(unittest.TestCase):
    """PostingCategoryCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostingCategoryCreate:
        """Test PostingCategoryCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostingCategoryCreate`
        """
        model = PostingCategoryCreate()
        if include_optional:
    ...
    def testPostingCategoryCreate(self):
        """Test PostingCategoryCreate"""
