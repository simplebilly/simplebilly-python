...
class TestPluginErrorOneOf2(unittest.TestCase):
    """PluginErrorOneOf2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PluginErrorOneOf2:
        """Test PluginErrorOneOf2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginErrorOneOf2`
        """
        model = PluginErrorOneOf2()
        if include_optional:
    ...
    def testPluginErrorOneOf2(self):
        """Test PluginErrorOneOf2"""
