...
class TestWarehouseCreate(unittest.TestCase):
    """WarehouseCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WarehouseCreate:
        """Test WarehouseCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WarehouseCreate`
        """
