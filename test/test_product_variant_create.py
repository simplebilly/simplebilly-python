...
class TestProductVariantCreate(unittest.TestCase):
    """ProductVariantCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductVariantCreate:
    ...
    def testProductVariantCreate(self):
        """Test ProductVariantCreate"""
