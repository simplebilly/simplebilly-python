...
class TestEmailTemplateCreate(unittest.TestCase):
    """EmailTemplateCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailTemplateCreate:
        """Test EmailTemplateCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailTemplateCreate`
        """
        model = EmailTemplateCreate()
        if include_optional:
    ...
    def testEmailTemplateCreate(self):
        """Test EmailTemplateCreate"""
