...
class TestDeliveryDateStatus(unittest.TestCase):
    """DeliveryDateStatus unit test stubs"""
    ...
    def testDeliveryDateStatus(self):
        """Test DeliveryDateStatus"""
        # inst = DeliveryDateStatus()
