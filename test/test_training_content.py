...
class TestTrainingContent(unittest.TestCase):
    """TrainingContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrainingContent:
        """Test TrainingContent
        ...
        if include_optional:
            return TrainingContent(
                code = '',
                contact = simplebilly_api.models.contact_info.ContactInfo(
                    hint = '', 
                    hint_en = '', 
                    role = '', 
                    role_en = '', ),
                pass_score = 56,
                quiz = [
                    simplebilly_api.models.quiz_question.QuizQuestion(
                        id = '', 
                        options = [
                            ''
                            ], 
                ...
                sections = [
                    simplebilly_api.models.section.Section(
                        body_html = '', 
                        body_html_en = '', 
                        id = '', 
                        title = '', 
