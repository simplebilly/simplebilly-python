...
class TestQuotaOverrideFeatures(unittest.TestCase):
    """QuotaOverrideFeatures unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuotaOverrideFeatures:
        """Test QuotaOverrideFeatures
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuotaOverrideFeatures`
        """
        model = QuotaOverrideFeatures()
        if include_optional:
    ...
    def testQuotaOverrideFeatures(self):
        """Test QuotaOverrideFeatures"""
