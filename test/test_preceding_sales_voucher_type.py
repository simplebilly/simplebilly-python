...
class TestPrecedingSalesVoucherType(unittest.TestCase):
    """PrecedingSalesVoucherType unit test stubs"""
    ...
    def testPrecedingSalesVoucherType(self):
        """Test PrecedingSalesVoucherType"""
        # inst = PrecedingSalesVoucherType()
