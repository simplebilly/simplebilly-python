...
class TestPurchaseOrderUpdate(unittest.TestCase):
    """PurchaseOrderUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PurchaseOrderUpdate:
        """Test PurchaseOrderUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PurchaseOrderUpdate`
        """
    ...
    def testPurchaseOrderUpdate(self):
        """Test PurchaseOrderUpdate"""
