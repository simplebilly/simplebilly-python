...
class TestBetriebsstaettenDetail(unittest.TestCase):
    """BetriebsstaettenDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetriebsstaettenDetail:
        """Test BetriebsstaettenDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetriebsstaettenDetail`
        """
        model = BetriebsstaettenDetail()
        if include_optional:
    ...
    def testBetriebsstaettenDetail(self):
        """Test BetriebsstaettenDetail"""
