...
class TestKycRecordUpdate(unittest.TestCase):
    """KycRecordUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KycRecordUpdate:
        """Test KycRecordUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KycRecordUpdate`
        """
        model = KycRecordUpdate()
        if include_optional:
