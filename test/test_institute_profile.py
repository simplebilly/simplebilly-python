...
class TestInstituteProfile(unittest.TestCase):
    """InstituteProfile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstituteProfile:
        """Test InstituteProfile
