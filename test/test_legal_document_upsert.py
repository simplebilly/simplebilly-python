...
class TestLegalDocumentUpsert(unittest.TestCase):
    """LegalDocumentUpsert unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegalDocumentUpsert:
        """Test LegalDocumentUpsert
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LegalDocumentUpsert`
        """
        model = LegalDocumentUpsert()
        if include_optional:
    ...
    def testLegalDocumentUpsert(self):
        """Test LegalDocumentUpsert"""
