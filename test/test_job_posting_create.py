...
class TestJobPostingCreate(unittest.TestCase):
    """JobPostingCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobPostingCreate:
        """Test JobPostingCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobPostingCreate`
        """
        model = JobPostingCreate()
        if include_optional:
