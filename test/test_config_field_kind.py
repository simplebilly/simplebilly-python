...
class TestConfigFieldKind(unittest.TestCase):
    """ConfigFieldKind unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigFieldKind:
        """Test ConfigFieldKind
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigFieldKind`
        """
        model = ConfigFieldKind()
        if include_optional:
