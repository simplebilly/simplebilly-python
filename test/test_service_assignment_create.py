...
class TestServiceAssignmentCreate(unittest.TestCase):
    """ServiceAssignmentCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceAssignmentCreate:
        """Test ServiceAssignmentCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceAssignmentCreate`
        """
        model = ServiceAssignmentCreate()
        if include_optional:
            return ServiceAssignmentCreate(
                employee_id = '',
                job_id = '',
                notes = '',
    ...
    def testServiceAssignmentCreate(self):
        """Test ServiceAssignmentCreate"""
