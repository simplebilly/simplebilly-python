...
class TestAnlageSKfzHinweis(unittest.TestCase):
    """AnlageSKfzHinweis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnlageSKfzHinweis:
        """Test AnlageSKfzHinweis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnlageSKfzHinweis`
        """
        model = AnlageSKfzHinweis()
        if include_optional:
    ...
    def testAnlageSKfzHinweis(self):
        """Test AnlageSKfzHinweis"""
