...
class TestKonzernThresholds(unittest.TestCase):
    """KonzernThresholds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KonzernThresholds:
        """Test KonzernThresholds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KonzernThresholds`
        """
        model = KonzernThresholds()
        if include_optional:
    ...
    def testKonzernThresholds(self):
        """Test KonzernThresholds"""
