...
class TestCouponUpdate(unittest.TestCase):
    """CouponUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CouponUpdate:
        """Test CouponUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CouponUpdate`
        """
        model = CouponUpdate()
        if include_optional:
            return CouponUpdate(
