...
class TestGenerateVariantsRequest(unittest.TestCase):
    """GenerateVariantsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateVariantsRequest:
        """Test GenerateVariantsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateVariantsRequest`
        """
        model = GenerateVariantsRequest()
        if include_optional:
    ...
    def testGenerateVariantsRequest(self):
        """Test GenerateVariantsRequest"""
